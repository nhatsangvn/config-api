...
def get_request():
    ...
    print("Greenlet ID: %s" % (current_greenlet))
    print("Current API Context: %s" % (str(current_greenlet.api_context)))
    print("VNG Req: %s" % (str(current_greenlet.api_context.request)))
