...
def generate_schema_graph():
    ...
    netconf_profile_node = pydot.Node('netconf-profile')
    graph.add_node(netconf_profile_node)
    ...
    structured_syslog_tenant_record_node = pydot.Node('structured-syslog-tenant-record')
    graph.add_node(structured_syslog_tenant_record_node)
    ...
    config_properties_node = pydot.Node('config-properties')
    graph.add_node(config_properties_node)
    ...
    snmp_profile_node = pydot.Node('snmp-profile')
    graph.add_node(snmp_profile_node)
    node_node = pydot.Node('node')
    graph.add_node(node_node)
    grpc_profile_node = pydot.Node('grpc-profile')
    graph.add_node(grpc_profile_node)
    ...
    graph.add_edge(pydot.Edge(structured_syslog_config_node, structured_syslog_tenant_record_node, color = 'red'))
    ...
    graph.add_edge(pydot.Edge(logical_router_node, fabric_node, color = 'blue', constraint = False))
    ...
    graph.add_edge(pydot.Edge(global_system_config_node, config_properties_node, color = 'red'))
    ...
    graph.add_edge(pydot.Edge(netconf_profile_node, tag_node, color = 'blue', constraint = False))
    ...
    graph.add_edge(pydot.Edge(virtual_machine_interface_node, virtual_port_group_node, color = 'blue', constraint = False))
    ...
    graph.add_edge(pydot.Edge(structured_syslog_tenant_record_node, tag_node, color = 'blue', constraint = False))
    ...
    graph.add_edge(pydot.Edge(routing_policy_node, interface_route_table_node, color = 'blue', constraint = False))
    ...
    graph.add_edge(pydot.Edge(project_node, grpc_profile_node, color = 'red'))
    graph.add_edge(pydot.Edge(project_node, snmp_profile_node, color = 'red'))
    graph.add_edge(pydot.Edge(project_node, netconf_profile_node, color = 'red'))
    ...
    graph.add_edge(pydot.Edge(config_properties_node, tag_node, color = 'blue', constraint = False))
    ...
    graph.add_edge(pydot.Edge(telemetry_profile_node, grpc_profile_node, color = 'blue', constraint = False))
    graph.add_edge(pydot.Edge(telemetry_profile_node, netconf_profile_node, color = 'blue', constraint = False))
    graph.add_edge(pydot.Edge(telemetry_profile_node, snmp_profile_node, color = 'blue', constraint = False))
    ...
    graph.add_edge(pydot.Edge(virtual_network_node, service_health_check_node, color = 'blue', constraint = False))
    ...
    graph.add_edge(pydot.Edge(snmp_profile_node, tag_node, color = 'blue', constraint = False))
    ...
    graph.add_edge(pydot.Edge(grpc_profile_node, tag_node, color = 'blue', constraint = False))
    ...
    graph.add_edge(pydot.Edge(data_center_interconnect_node, fabric_node, color = 'blue', constraint = False))
