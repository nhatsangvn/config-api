...
class ConnectionDriverBase(with_metaclass(abc.ABCMeta, object)):
    ...
    def netconf_profile_create(self, obj):
        """Create new netconf-profile.
        
        :param obj: :class:`.NetconfProfile` object
        
        """
        raise NotImplementedError('netconf_profile_create is %s\'s responsibility' % (str(type (self))))
    # end netconf_profile_create

    def netconf_profile_read(self, fq_name = None, fq_name_str = None, id = None, ifmap_id = None):
        """Return netconf-profile information.
        
        :param fq_name: Fully qualified name of netconf-profile
        :param fq_name_str: Fully qualified name string of netconf-profile
        :param id: UUID of netconf-profile
        :param ifmap_id: IFMAP id of netconf-profile
        :returns: :class:`.NetconfProfile` object
        
        """
        raise NotImplementedError('netconf_profile_read is %s\'s responsibility' % (str(type (self))))
    # end netconf_profile_read

    def netconf_profile_update(self, obj):
        """Update netconf-profile.
        
        :param obj: :class:`.NetconfProfile` object
        
        """
        raise NotImplementedError('netconf_profile_update is %s\'s responsibility' % (str(type (self))))
    # end netconf_profile_update

    def netconf_profiles_list(self, parent_id = None, parent_fq_name = None, back_ref_id = None, obj_uuids = None, fields = None, detail = False, count = False):
        """List all netconf-profiles.
        
        :param parent_id: UUID of parent as optional search filter
        :param parent_fq_name: full qualified name of parent as optional search filter
        :returns: list of :class:`.NetconfProfile` objects
        
        """
        raise NotImplementedError('netconf_profiles_list is %s\'s responsibility' % (str(type (self))))
    # end netconf_profiles_list

    def netconf_profile_delete(self, fq_name = None, id = None, ifmap_id = None):
        """Delete netconf-profile from the system.
        ...
        """
        raise NotImplementedError('netconf_profile_delete is %s\'s responsibility' % (str(type (self))))
    # end netconf_profile_delete

    def get_default_netconf_profile_id(self):
        """Return UUID of default netconf-profile."""
        raise NotImplementedError('get_default_netconf_profile_delete is %s\'s responsibility' % (str(type (self))))
    # end get_default_netconf_profile_delete
    ...
    def structured_syslog_tenant_record_create(self, obj):
        """Create new structured-syslog-tenant-record.
        
        :param obj: :class:`.StructuredSyslogTenantRecord` object
        
        """
        raise NotImplementedError('structured_syslog_tenant_record_create is %s\'s responsibility' % (str(type (self))))
    # end structured_syslog_tenant_record_create

    def structured_syslog_tenant_record_read(self, fq_name = None, fq_name_str = None, id = None, ifmap_id = None):
        """Return structured-syslog-tenant-record information.
        
        :param fq_name: Fully qualified name of structured-syslog-tenant-record
        :param fq_name_str: Fully qualified name string of structured-syslog-tenant-record
        :param id: UUID of structured-syslog-tenant-record
        :param ifmap_id: IFMAP id of structured-syslog-tenant-record
        :returns: :class:`.StructuredSyslogTenantRecord` object
        
        """
        raise NotImplementedError('structured_syslog_tenant_record_read is %s\'s responsibility' % (str(type (self))))
    # end structured_syslog_tenant_record_read

    def structured_syslog_tenant_record_update(self, obj):
        """Update structured-syslog-tenant-record.
        
        :param obj: :class:`.StructuredSyslogTenantRecord` object
        
        """
        raise NotImplementedError('structured_syslog_tenant_record_update is %s\'s responsibility' % (str(type (self))))
    # end structured_syslog_tenant_record_update

    def structured_syslog_tenant_records_list(self, parent_id = None, parent_fq_name = None, back_ref_id = None, obj_uuids = None, fields = None, detail = False, count = False):
        """List all structured-syslog-tenant-records.
        
        :param parent_id: UUID of parent as optional search filter
        :param parent_fq_name: full qualified name of parent as optional search filter
        :returns: list of :class:`.StructuredSyslogTenantRecord` objects
        
        """
        raise NotImplementedError('structured_syslog_tenant_records_list is %s\'s responsibility' % (str(type (self))))
    # end structured_syslog_tenant_records_list

    def structured_syslog_tenant_record_delete(self, fq_name = None, id = None, ifmap_id = None):
        """Delete structured-syslog-tenant-record from the system.
        ...
        """
        raise NotImplementedError('structured_syslog_tenant_record_delete is %s\'s responsibility' % (str(type (self))))
    # end structured_syslog_tenant_record_delete

    def get_default_structured_syslog_tenant_record_id(self):
        """Return UUID of default structured-syslog-tenant-record."""
        raise NotImplementedError('get_default_structured_syslog_tenant_record_delete is %s\'s responsibility' % (str(type (self))))
    # end get_default_structured_syslog_tenant_record_delete
    ...
    def config_properties_create(self, obj):
        """Create new config-properties.
        
        :param obj: :class:`.ConfigProperties` object
        
        """
        raise NotImplementedError('config_properties_create is %s\'s responsibility' % (str(type (self))))
    # end config_properties_create

    def config_properties_read(self, fq_name = None, fq_name_str = None, id = None, ifmap_id = None):
        """Return config-properties information.
        
        :param fq_name: Fully qualified name of config-properties
        :param fq_name_str: Fully qualified name string of config-properties
        :param id: UUID of config-properties
        :param ifmap_id: IFMAP id of config-properties
        :returns: :class:`.ConfigProperties` object
        
        """
        raise NotImplementedError('config_properties_read is %s\'s responsibility' % (str(type (self))))
    # end config_properties_read

    def config_properties_update(self, obj):
        """Update config-properties.
        
        :param obj: :class:`.ConfigProperties` object
        
        """
        raise NotImplementedError('config_properties_update is %s\'s responsibility' % (str(type (self))))
    # end config_properties_update

    def config_propertiess_list(self, parent_id = None, parent_fq_name = None, back_ref_id = None, obj_uuids = None, fields = None, detail = False, count = False):
        """List all config-propertiess.
        
        :param parent_id: UUID of parent as optional search filter
        :param parent_fq_name: full qualified name of parent as optional search filter
        :returns: list of :class:`.ConfigProperties` objects
        
        """
        raise NotImplementedError('config_propertiess_list is %s\'s responsibility' % (str(type (self))))
    # end config_propertiess_list

    def config_properties_delete(self, fq_name = None, id = None, ifmap_id = None):
        """Delete config-properties from the system.
        ...
        """
        raise NotImplementedError('config_properties_delete is %s\'s responsibility' % (str(type (self))))
    # end config_properties_delete

    def get_default_config_properties_id(self):
        """Return UUID of default config-properties."""
        raise NotImplementedError('get_default_config_properties_delete is %s\'s responsibility' % (str(type (self))))
    # end get_default_config_properties_delete
    ...
    def snmp_profile_create(self, obj):
        """Create new snmp-profile.
        
        :param obj: :class:`.SnmpProfile` object
        
        """
        raise NotImplementedError('snmp_profile_create is %s\'s responsibility' % (str(type (self))))
    # end snmp_profile_create

    def snmp_profile_read(self, fq_name = None, fq_name_str = None, id = None, ifmap_id = None):
        """Return snmp-profile information.
        
        :param fq_name: Fully qualified name of snmp-profile
        :param fq_name_str: Fully qualified name string of snmp-profile
        :param id: UUID of snmp-profile
        :param ifmap_id: IFMAP id of snmp-profile
        :returns: :class:`.SnmpProfile` object
        
        """
        raise NotImplementedError('snmp_profile_read is %s\'s responsibility' % (str(type (self))))
    # end snmp_profile_read

    def snmp_profile_update(self, obj):
        """Update snmp-profile.
        
        :param obj: :class:`.SnmpProfile` object
        
        """
        raise NotImplementedError('snmp_profile_update is %s\'s responsibility' % (str(type (self))))
    # end snmp_profile_update

    def snmp_profiles_list(self, parent_id = None, parent_fq_name = None, back_ref_id = None, obj_uuids = None, fields = None, detail = False, count = False):
        """List all snmp-profiles.
        
        :param parent_id: UUID of parent as optional search filter
        :param parent_fq_name: full qualified name of parent as optional search filter
        :returns: list of :class:`.SnmpProfile` objects
        
        """
        raise NotImplementedError('snmp_profiles_list is %s\'s responsibility' % (str(type (self))))
    # end snmp_profiles_list

    def snmp_profile_delete(self, fq_name = None, id = None, ifmap_id = None):
        """Delete snmp-profile from the system.
        ...
        """
        raise NotImplementedError('snmp_profile_delete is %s\'s responsibility' % (str(type (self))))
    # end snmp_profile_delete

    def get_default_snmp_profile_id(self):
        """Return UUID of default snmp-profile."""
        raise NotImplementedError('get_default_snmp_profile_delete is %s\'s responsibility' % (str(type (self))))
    # end get_default_snmp_profile_delete
    ...
    def grpc_profile_create(self, obj):
        """Create new grpc-profile.
        
        :param obj: :class:`.GrpcProfile` object
        
        """
        raise NotImplementedError('grpc_profile_create is %s\'s responsibility' % (str(type (self))))
    # end grpc_profile_create

    def grpc_profile_read(self, fq_name = None, fq_name_str = None, id = None, ifmap_id = None):
        """Return grpc-profile information.
        
        :param fq_name: Fully qualified name of grpc-profile
        :param fq_name_str: Fully qualified name string of grpc-profile
        :param id: UUID of grpc-profile
        :param ifmap_id: IFMAP id of grpc-profile
        :returns: :class:`.GrpcProfile` object
        
        """
        raise NotImplementedError('grpc_profile_read is %s\'s responsibility' % (str(type (self))))
    # end grpc_profile_read

    def grpc_profile_update(self, obj):
        """Update grpc-profile.
        
        :param obj: :class:`.GrpcProfile` object
        
        """
        raise NotImplementedError('grpc_profile_update is %s\'s responsibility' % (str(type (self))))
    # end grpc_profile_update

    def grpc_profiles_list(self, parent_id = None, parent_fq_name = None, back_ref_id = None, obj_uuids = None, fields = None, detail = False, count = False):
        """List all grpc-profiles.
        
        :param parent_id: UUID of parent as optional search filter
        :param parent_fq_name: full qualified name of parent as optional search filter
        :returns: list of :class:`.GrpcProfile` objects
        
        """
        raise NotImplementedError('grpc_profiles_list is %s\'s responsibility' % (str(type (self))))
    # end grpc_profiles_list

    def grpc_profile_delete(self, fq_name = None, id = None, ifmap_id = None):
        """Delete grpc-profile from the system.
        ...
        """
        raise NotImplementedError('grpc_profile_delete is %s\'s responsibility' % (str(type (self))))
    # end grpc_profile_delete

    def get_default_grpc_profile_id(self):
        """Return UUID of default grpc-profile."""
        raise NotImplementedError('get_default_grpc_profile_delete is %s\'s responsibility' % (str(type (self))))
    # end get_default_grpc_profile_delete
