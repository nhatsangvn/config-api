...
class ContrailServiceHealthCheck(contrail.ContrailResource):
        ...
        SERVICE_HEALTH_CHECK_PROPERTIES: properties.Schema(
            ...
            schema={
                ...
                SERVICE_HEALTH_CHECK_PROPERTIES_HEALTH_CHECK_TYPE: properties.Schema(
                    ...
                    required=False,
                    constraints=[
                        constraints.AllowedValues([u'link-local', u'end-to-end', u'segment', u'vn-ip-list']),
                    ],
                ),
                ...
                SERVICE_HEALTH_CHECK_PROPERTIES_TARGET_IP_ALL: properties.Schema(
                    properties.Schema.BOOLEAN,
                    _('SERVICE_HEALTH_CHECK_PROPERTIES_TARGET_IP_ALL.'),
                    update_allowed=True,
                    required=False,
                ),
                SERVICE_HEALTH_CHECK_PROPERTIES_TARGET_IP_LIST: properties.Schema(
                    properties.Schema.MAP,
                    _('SERVICE_HEALTH_CHECK_PROPERTIES_TARGET_IP_LIST.'),
                    update_allowed=True,
                    required=False,
                    schema={
                        SERVICE_HEALTH_CHECK_PROPERTIES_TARGET_IP_LIST_IP_ADDRESS: properties.Schema(
                            properties.Schema.LIST,
                            _('SERVICE_HEALTH_CHECK_PROPERTIES_TARGET_IP_LIST_IP_ADDRESS.'),
                            update_allowed=True,
                            required=False,
                        ),
                    }
    ...
    def handle_create(self):
        ...
        if self.properties.get(self.SERVICE_HEALTH_CHECK_PROPERTIES) is not None:
            ...
            if self.properties.get(self.SERVICE_HEALTH_CHECK_PROPERTIES, {}).get(self.SERVICE_HEALTH_CHECK_PROPERTIES_TARGET_IP_ALL) is not None:
                obj_1.set_target_ip_all(self.properties.get(self.SERVICE_HEALTH_CHECK_PROPERTIES, {}).get(self.SERVICE_HEALTH_CHECK_PROPERTIES_TARGET_IP_ALL))
            if self.properties.get(self.SERVICE_HEALTH_CHECK_PROPERTIES, {}).get(self.SERVICE_HEALTH_CHECK_PROPERTIES_TARGET_IP_LIST) is not None:
                obj_2 = vnc_api.IpAddressesType()
                if self.properties.get(self.SERVICE_HEALTH_CHECK_PROPERTIES, {}).get(self.SERVICE_HEALTH_CHECK_PROPERTIES_TARGET_IP_LIST, {}).get(self.SERVICE_HEALTH_CHECK_PROPERTIES_TARGET_IP_LIST_IP_ADDRESS) is not None:
                    for index_2 in range(len(self.properties.get(self.SERVICE_HEALTH_CHECK_PROPERTIES, {}).get(self.SERVICE_HEALTH_CHECK_PROPERTIES_TARGET_IP_LIST, {}).get(self.SERVICE_HEALTH_CHECK_PROPERTIES_TARGET_IP_LIST_IP_ADDRESS))):
                        obj_2.add_ip_address(self.properties.get(self.SERVICE_HEALTH_CHECK_PROPERTIES, {}).get(self.SERVICE_HEALTH_CHECK_PROPERTIES_TARGET_IP_LIST, {}).get(self.SERVICE_HEALTH_CHECK_PROPERTIES_TARGET_IP_LIST_IP_ADDRESS)[index_2])
                obj_1.set_target_ip_list(obj_2)
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        ...
        if prop_diff.get(self.SERVICE_HEALTH_CHECK_PROPERTIES) is not None:
            ...
            if prop_diff.get(self.SERVICE_HEALTH_CHECK_PROPERTIES, {}).get(self.SERVICE_HEALTH_CHECK_PROPERTIES_TARGET_IP_ALL) is not None:
                obj_1.set_target_ip_all(prop_diff.get(self.SERVICE_HEALTH_CHECK_PROPERTIES, {}).get(self.SERVICE_HEALTH_CHECK_PROPERTIES_TARGET_IP_ALL))
            if prop_diff.get(self.SERVICE_HEALTH_CHECK_PROPERTIES, {}).get(self.SERVICE_HEALTH_CHECK_PROPERTIES_TARGET_IP_LIST) is not None:
                obj_2 = vnc_api.IpAddressesType()
                if prop_diff.get(self.SERVICE_HEALTH_CHECK_PROPERTIES, {}).get(self.SERVICE_HEALTH_CHECK_PROPERTIES_TARGET_IP_LIST, {}).get(self.SERVICE_HEALTH_CHECK_PROPERTIES_TARGET_IP_LIST_IP_ADDRESS) is not None:
                    for index_2 in range(len(prop_diff.get(self.SERVICE_HEALTH_CHECK_PROPERTIES, {}).get(self.SERVICE_HEALTH_CHECK_PROPERTIES_TARGET_IP_LIST, {}).get(self.SERVICE_HEALTH_CHECK_PROPERTIES_TARGET_IP_LIST_IP_ADDRESS))):
                        obj_2.add_ip_address(prop_diff.get(self.SERVICE_HEALTH_CHECK_PROPERTIES, {}).get(self.SERVICE_HEALTH_CHECK_PROPERTIES_TARGET_IP_LIST, {}).get(self.SERVICE_HEALTH_CHECK_PROPERTIES_TARGET_IP_LIST_IP_ADDRESS)[index_2])
                obj_1.set_target_ip_list(obj_2)
            obj_0.set_service_health_check_properties(obj_1)
