...
class ContrailDeviceImage(contrail.ContrailResource):
    ...
    properties_schema = {
        ...
        DEVICE_IMAGE_FILE_NAME: properties.Schema(
            properties.Schema.STRING,
            _('DEVICE_IMAGE_FILE_NAME.'),
            update_allowed=True,
            required=False,
        ),
    ...
    attributes_schema = {
        ...
        DEVICE_IMAGE_FILE_NAME: attributes.Schema(
            _('DEVICE_IMAGE_FILE_NAME.'),
        ),
    ...
    def handle_create(self):
        ...
        if self.properties.get(self.DEVICE_IMAGE_FILE_NAME) is not None:
            obj_0.set_device_image_file_name(self.properties.get(self.DEVICE_IMAGE_FILE_NAME))
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        ...
        if prop_diff.get(self.DEVICE_IMAGE_FILE_NAME) is not None:
            obj_0.set_device_image_file_name(prop_diff.get(self.DEVICE_IMAGE_FILE_NAME))
