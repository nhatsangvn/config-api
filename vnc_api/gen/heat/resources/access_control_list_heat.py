                        ...
                        schema={
                            ...
                            ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE_ACTION_LIST: properties.Schema(
                                ...
                                schema={
                                    ...
                                    ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE_ACTION_LIST_SERVICE_PROPERTIES: properties.Schema(
                                        properties.Schema.MAP,
                                        _('ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE_ACTION_LIST_SERVICE_PROPERTIES.'),
                                        update_allowed=True,
                                        required=False,
                                        schema={
                                            ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE_ACTION_LIST_SERVICE_PROPERTIES_RETAIN_AS_PATH: properties.Schema(
                                                properties.Schema.BOOLEAN,
                                                _('ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE_ACTION_LIST_SERVICE_PROPERTIES_RETAIN_AS_PATH.'),
                                                update_allowed=True,
                                                required=False,
                                            ),
                                        }
            ...
            if self.properties.get(self.ACCESS_CONTROL_LIST_ENTRIES, {}).get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE) is not None:
                for index_1 in range(len(self.properties.get(self.ACCESS_CONTROL_LIST_ENTRIES, {}).get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE))):
                    ...
                    if self.properties.get(self.ACCESS_CONTROL_LIST_ENTRIES, {}).get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE, {})[index_1].get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE_ACTION_LIST) is not None:
                        ...
                        if self.properties.get(self.ACCESS_CONTROL_LIST_ENTRIES, {}).get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE, {})[index_1].get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE_ACTION_LIST, {}).get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE_ACTION_LIST_SERVICE_PROPERTIES) is not None:
                            obj_4 = vnc_api.ServicePropertiesType()
                            if self.properties.get(self.ACCESS_CONTROL_LIST_ENTRIES, {}).get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE, {})[index_1].get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE_ACTION_LIST, {}).get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE_ACTION_LIST_SERVICE_PROPERTIES, {}).get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE_ACTION_LIST_SERVICE_PROPERTIES_RETAIN_AS_PATH) is not None:
                                obj_4.set_retain_as_path(self.properties.get(self.ACCESS_CONTROL_LIST_ENTRIES, {}).get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE, {})[index_1].get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE_ACTION_LIST, {}).get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE_ACTION_LIST_SERVICE_PROPERTIES, {}).get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE_ACTION_LIST_SERVICE_PROPERTIES_RETAIN_AS_PATH))
            ...
            if prop_diff.get(self.ACCESS_CONTROL_LIST_ENTRIES, {}).get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE) is not None:
                for index_1 in range(len(prop_diff.get(self.ACCESS_CONTROL_LIST_ENTRIES, {}).get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE))):
                    ...
                    if prop_diff.get(self.ACCESS_CONTROL_LIST_ENTRIES, {}).get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE, {})[index_1].get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE_ACTION_LIST) is not None:
                        ...
                        if prop_diff.get(self.ACCESS_CONTROL_LIST_ENTRIES, {}).get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE, {})[index_1].get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE_ACTION_LIST, {}).get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE_ACTION_LIST_SERVICE_PROPERTIES) is not None:
                            obj_4 = vnc_api.ServicePropertiesType()
                            if prop_diff.get(self.ACCESS_CONTROL_LIST_ENTRIES, {}).get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE, {})[index_1].get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE_ACTION_LIST, {}).get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE_ACTION_LIST_SERVICE_PROPERTIES, {}).get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE_ACTION_LIST_SERVICE_PROPERTIES_RETAIN_AS_PATH) is not None:
                                obj_4.set_retain_as_path(prop_diff.get(self.ACCESS_CONTROL_LIST_ENTRIES, {}).get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE, {})[index_1].get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE_ACTION_LIST, {}).get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE_ACTION_LIST_SERVICE_PROPERTIES, {}).get(self.ACCESS_CONTROL_LIST_ENTRIES_ACL_RULE_ACTION_LIST_SERVICE_PROPERTIES_RETAIN_AS_PATH))
                            obj_3.set_service_properties(obj_4)
