...
class ContrailVirtualMachineInterface(contrail.ContrailResource):
    ...
    properties_schema = {
        ...
        VIRTUAL_PORT_GROUP_REFS: properties.Schema(
            properties.Schema.LIST,
            _('VIRTUAL_PORT_GROUP_REFS.'),
            update_allowed=True,
            required=False,
        ),
        VIRTUAL_PORT_GROUP_REFS_DATA: properties.Schema(
            properties.Schema.LIST,
            _('VIRTUAL_PORT_GROUP_REFS_DATA.'),
            update_allowed=True,
            required=False,
            schema=properties.Schema(
                properties.Schema.MAP,
                schema={
                    VIRTUAL_PORT_GROUP_REFS_DATA_VLAN_TAG: properties.Schema(
                        properties.Schema.INTEGER,
                        _('VIRTUAL_PORT_GROUP_REFS_DATA_VLAN_TAG.'),
                        update_allowed=True,
                        required=False,
                        constraints=[
                            constraints.Range(0, 4094),
                    ...
                    VIRTUAL_PORT_GROUP_REFS_DATA_NATIVE_VLAN_TAG: properties.Schema(
                        properties.Schema.INTEGER,
                        _('VIRTUAL_PORT_GROUP_REFS_DATA_NATIVE_VLAN_TAG.'),
                        update_allowed=True,
                        required=False,
                        constraints=[
                            constraints.Range(0, 4094),
    ...
    attributes_schema = {
        ...
        VIRTUAL_PORT_GROUP_REFS: attributes.Schema(
            _('VIRTUAL_PORT_GROUP_REFS.'),
        ),
        VIRTUAL_PORT_GROUP_REFS_DATA: attributes.Schema(
            _('VIRTUAL_PORT_GROUP_REFS_DATA.'),
        ),
    ...
    def handle_create(self):
        ...
        # reference to virtual_port_group_refs
        if len(self.properties.get(self.VIRTUAL_PORT_GROUP_REFS) or []) != len(self.properties.get(self.VIRTUAL_PORT_GROUP_REFS_DATA) or []):
            raise Exception(_('virtual-machine-interface: specify virtual_port_group_refs for each virtual_port_group_refs_data.'))
        obj_1 = None
        if self.properties.get(self.VIRTUAL_PORT_GROUP_REFS_DATA) is not None:
            for index_0 in range(len(self.properties.get(self.VIRTUAL_PORT_GROUP_REFS_DATA))):
                obj_1 = vnc_api.VMIVirtualPortGroupAttributes()
                if self.properties.get(self.VIRTUAL_PORT_GROUP_REFS_DATA, {})[index_0].get(self.VIRTUAL_PORT_GROUP_REFS_DATA_VLAN_TAG) is not None:
                    obj_1.set_vlan_tag(self.properties.get(self.VIRTUAL_PORT_GROUP_REFS_DATA, {})[index_0].get(self.VIRTUAL_PORT_GROUP_REFS_DATA_VLAN_TAG))
                if self.properties.get(self.VIRTUAL_PORT_GROUP_REFS_DATA, {})[index_0].get(self.VIRTUAL_PORT_GROUP_REFS_DATA_NATIVE_VLAN_TAG) is not None:
                    obj_1.set_native_vlan_tag(self.properties.get(self.VIRTUAL_PORT_GROUP_REFS_DATA, {})[index_0].get(self.VIRTUAL_PORT_GROUP_REFS_DATA_NATIVE_VLAN_TAG))

                if self.properties.get(self.VIRTUAL_PORT_GROUP_REFS):
                    try:
                        ref_obj = self.vnc_lib().virtual_port_group_read(
                            id=self.properties.get(self.VIRTUAL_PORT_GROUP_REFS)[index_0]
                        )
                    except vnc_api.NoIdError:
                        ref_obj = self.vnc_lib().virtual_port_group_read(
                            fq_name_str=self.properties.get(self.VIRTUAL_PORT_GROUP_REFS)[index_0]
                        )
                    except Exception as e:
                        raise Exception(_('%s') % str(e))
                    obj_0.add_virtual_port_group(ref_obj, obj_1)
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        ...
        # reference to virtual_port_group
        update = 0
        if not self.VIRTUAL_PORT_GROUP_REFS in prop_diff:
            ref_obj_list = [ref['to'] for ref in obj_0.get_virtual_port_group_refs() or []]
        else:
            ref_obj_list = []
            update = 1
        if not self.VIRTUAL_PORT_GROUP_REFS_DATA in prop_diff:
            ref_data_list = [ref['attr'] for ref in obj_0.get_virtual_port_group_refs() or []]
        else:
            ref_data_list = []

        if prop_diff.get(self.VIRTUAL_PORT_GROUP_REFS_DATA) is not None:
            for index_0 in range(len(prop_diff.get(self.VIRTUAL_PORT_GROUP_REFS_DATA))):
                obj_1 = vnc_api.VMIVirtualPortGroupAttributes()
                if prop_diff.get(self.VIRTUAL_PORT_GROUP_REFS_DATA, {})[index_0].get(self.VIRTUAL_PORT_GROUP_REFS_DATA_VLAN_TAG) is not None:
                    obj_1.set_vlan_tag(prop_diff.get(self.VIRTUAL_PORT_GROUP_REFS_DATA, {})[index_0].get(self.VIRTUAL_PORT_GROUP_REFS_DATA_VLAN_TAG))
                if prop_diff.get(self.VIRTUAL_PORT_GROUP_REFS_DATA, {})[index_0].get(self.VIRTUAL_PORT_GROUP_REFS_DATA_NATIVE_VLAN_TAG) is not None:
                    obj_1.set_native_vlan_tag(prop_diff.get(self.VIRTUAL_PORT_GROUP_REFS_DATA, {})[index_0].get(self.VIRTUAL_PORT_GROUP_REFS_DATA_NATIVE_VLAN_TAG))
                ref_data_list.append(obj_1)
        if self.VIRTUAL_PORT_GROUP_REFS in prop_diff:
            for index_0 in range(len(prop_diff.get(self.VIRTUAL_PORT_GROUP_REFS) or [])):
                try:
                    ref_obj = self.vnc_lib().virtual_port_group_read(
                        id=prop_diff.get(self.VIRTUAL_PORT_GROUP_REFS)[index_0]
                    )
                except vnc_api.NoIdError:
                    ref_obj = self.vnc_lib().virtual_port_group_read(
                        fq_name_str=prop_diff.get(self.VIRTUAL_PORT_GROUP_REFS)[index_0]
                    )
                except Exception as e:
                    raise Exception(_('%s') % str(e))
                ref_obj_list.append(ref_obj.fq_name)
        ...
        if len(ref_obj_list) != len(ref_data_list):
            raise Exception(_('virtual-machine-interface: specify virtual_port_group_refs_data for each virtual_port_group_refs.'))

        if update or ref_obj_list or ref_data_list:
            obj_0.set_virtual_port_group_list(ref_obj_list, ref_data_list)
        # End: reference to virtual_port_group_refs
