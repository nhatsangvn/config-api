...
class ContrailPhysicalRouter(contrail.ContrailResource):
    ...
    properties_schema = {
        ...
        PHYSICAL_ROUTER_ONBOARDING_STATE: properties.Schema(
            properties.Schema.STRING,
            _('PHYSICAL_ROUTER_ONBOARDING_STATE.'),
            update_allowed=True,
            required=False,
        ),
    ...
    attributes_schema = {
        ...
        PHYSICAL_ROUTER_ONBOARDING_STATE: attributes.Schema(
            _('PHYSICAL_ROUTER_ONBOARDING_STATE.'),
        ),
    ...
    def handle_create(self):
        ...
        if self.properties.get(self.PHYSICAL_ROUTER_ONBOARDING_STATE) is not None:
            obj_0.set_physical_router_onboarding_state(self.properties.get(self.PHYSICAL_ROUTER_ONBOARDING_STATE))
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        ...
        if prop_diff.get(self.PHYSICAL_ROUTER_ONBOARDING_STATE) is not None:
            obj_0.set_physical_router_onboarding_state(prop_diff.get(self.PHYSICAL_ROUTER_ONBOARDING_STATE))
