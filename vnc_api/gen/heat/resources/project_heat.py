...
class ContrailProject(contrail.ContrailResource):
    ...
    properties_schema = {
        ...
        QUOTA: properties.Schema(
            ...
            schema={
                ...
                QUOTA_LOADBALANCER: properties.Schema(
                    properties.Schema.INTEGER,
                    _('QUOTA_LOADBALANCER.'),
                    update_allowed=True,
                    required=False,
                ),
                QUOTA_LOADBALANCER_LISTENER: properties.Schema(
                    properties.Schema.INTEGER,
                    _('QUOTA_LOADBALANCER_LISTENER.'),
                    update_allowed=True,
                    required=False,
                ),
    ...
    def handle_create(self):
        ...
        if self.properties.get(self.QUOTA) is not None:
            ...
            if self.properties.get(self.QUOTA, {}).get(self.QUOTA_LOADBALANCER) is not None:
                obj_1.set_loadbalancer(self.properties.get(self.QUOTA, {}).get(self.QUOTA_LOADBALANCER))
            if self.properties.get(self.QUOTA, {}).get(self.QUOTA_LOADBALANCER_LISTENER) is not None:
                obj_1.set_loadbalancer_listener(self.properties.get(self.QUOTA, {}).get(self.QUOTA_LOADBALANCER_LISTENER))
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        ...
        if prop_diff.get(self.QUOTA) is not None:
            ...
            if prop_diff.get(self.QUOTA, {}).get(self.QUOTA_LOADBALANCER) is not None:
                obj_1.set_loadbalancer(prop_diff.get(self.QUOTA, {}).get(self.QUOTA_LOADBALANCER))
            if prop_diff.get(self.QUOTA, {}).get(self.QUOTA_LOADBALANCER_LISTENER) is not None:
                obj_1.set_loadbalancer_listener(prop_diff.get(self.QUOTA, {}).get(self.QUOTA_LOADBALANCER_LISTENER))
