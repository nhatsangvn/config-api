...
class ContrailVirtualRouter(contrail.ContrailResource):
    ...
    properties_schema = {
        ...
        VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS: properties.Schema(
            properties.Schema.MAP,
            _('VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS.'),
            update_allowed=True,
            required=False,
            schema={
                VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS_KEY_VALUE_PAIR: properties.Schema(
                    properties.Schema.LIST,
                    _('VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS_KEY_VALUE_PAIR.'),
                    update_allowed=True,
                    required=False,
                    schema=properties.Schema(
                        properties.Schema.MAP,
                        schema={
                            VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS_KEY_VALUE_PAIR_KEY: properties.Schema(
                                properties.Schema.STRING,
                                _('VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS_KEY_VALUE_PAIR_KEY.'),
                                update_allowed=True,
                                required=False,
                            ),
                            VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS_KEY_VALUE_PAIR_VALUE: properties.Schema(
                                properties.Schema.STRING,
                                _('VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS_KEY_VALUE_PAIR_VALUE.'),
                                update_allowed=True,
                                required=False,
                            ),
                        }
    ...
    attributes_schema = {
        ...
        VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS: attributes.Schema(
            _('VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS.'),
        ),
    ...
    def handle_create(self):
        ...
        if self.properties.get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS) is not None:
            obj_1 = vnc_api.KeyValuePairs()
            if self.properties.get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS, {}).get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS_KEY_VALUE_PAIR) is not None:
                for index_1 in range(len(self.properties.get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS, {}).get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS_KEY_VALUE_PAIR))):
                    obj_2 = vnc_api.KeyValuePair()
                    if self.properties.get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS, {}).get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS_KEY_VALUE_PAIR, {})[index_1].get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS_KEY_VALUE_PAIR_KEY) is not None:
                        obj_2.set_key(self.properties.get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS, {}).get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS_KEY_VALUE_PAIR, {})[index_1].get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS_KEY_VALUE_PAIR_KEY))
                    if self.properties.get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS, {}).get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS_KEY_VALUE_PAIR, {})[index_1].get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS_KEY_VALUE_PAIR_VALUE) is not None:
                        obj_2.set_value(self.properties.get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS, {}).get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS_KEY_VALUE_PAIR, {})[index_1].get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS_KEY_VALUE_PAIR_VALUE))
                    obj_1.add_key_value_pair(obj_2)
            obj_0.set_virtual_router_sriov_physical_networks(obj_1)
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        ...
        if prop_diff.get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS) is not None:
            obj_1 = vnc_api.KeyValuePairs()
            if prop_diff.get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS, {}).get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS_KEY_VALUE_PAIR) is not None:
                for index_1 in range(len(prop_diff.get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS, {}).get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS_KEY_VALUE_PAIR))):
                    obj_2 = vnc_api.KeyValuePair()
                    if prop_diff.get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS, {}).get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS_KEY_VALUE_PAIR, {})[index_1].get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS_KEY_VALUE_PAIR_KEY) is not None:
                        obj_2.set_key(prop_diff.get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS, {}).get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS_KEY_VALUE_PAIR, {})[index_1].get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS_KEY_VALUE_PAIR_KEY))
                    if prop_diff.get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS, {}).get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS_KEY_VALUE_PAIR, {})[index_1].get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS_KEY_VALUE_PAIR_VALUE) is not None:
                        obj_2.set_value(prop_diff.get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS, {}).get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS_KEY_VALUE_PAIR, {})[index_1].get(self.VIRTUAL_ROUTER_SRIOV_PHYSICAL_NETWORKS_KEY_VALUE_PAIR_VALUE))
                    obj_1.add_key_value_pair(obj_2)
            obj_0.set_virtual_router_sriov_physical_networks(obj_1)
