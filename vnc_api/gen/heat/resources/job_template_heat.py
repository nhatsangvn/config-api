...
class ContrailJobTemplate(contrail.ContrailResource):
    ...
    properties_schema = {
        ...
        JOB_TEMPLATE_RECOVERY_PLAYBOOKS: properties.Schema(
            properties.Schema.MAP,
            _('JOB_TEMPLATE_RECOVERY_PLAYBOOKS.'),
            update_allowed=True,
            required=False,
            schema={
                JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO: properties.Schema(
                    properties.Schema.LIST,
                    _('JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO.'),
                    update_allowed=True,
                    required=False,
                    schema=properties.Schema(
                        properties.Schema.MAP,
                        schema={
                            JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_PLAYBOOK_URI: properties.Schema(
                                properties.Schema.STRING,
                                _('JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_PLAYBOOK_URI.'),
                                update_allowed=True,
                                required=False,
                            ),
                            JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_MULTI_DEVICE_PLAYBOOK: properties.Schema(
                                properties.Schema.BOOLEAN,
                                _('JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_MULTI_DEVICE_PLAYBOOK.'),
                                update_allowed=True,
                                required=False,
                            ),
                            JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_VENDOR: properties.Schema(
                                properties.Schema.STRING,
                                _('JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_VENDOR.'),
                                update_allowed=True,
                                required=False,
                            ),
                            JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_DEVICE_FAMILY: properties.Schema(
                                properties.Schema.STRING,
                                _('JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_DEVICE_FAMILY.'),
                                update_allowed=True,
                                required=False,
                            ),
                            JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_JOB_COMPLETION_WEIGHTAGE: properties.Schema(
                                properties.Schema.INTEGER,
                                _('JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_JOB_COMPLETION_WEIGHTAGE.'),
                                update_allowed=True,
                                required=False,
                            ),
                            JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_SEQUENCE_NO: properties.Schema(
                                properties.Schema.INTEGER,
                                _('JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_SEQUENCE_NO.'),
                                update_allowed=True,
                                required=False,
                            ),
                        }
    ...
    attributes_schema = {
        ...
        JOB_TEMPLATE_RECOVERY_PLAYBOOKS: attributes.Schema(
            _('JOB_TEMPLATE_RECOVERY_PLAYBOOKS.'),
        ),
    ...
    def handle_create(self):
        ...
        if self.properties.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS) is not None:
            obj_1 = vnc_api.PlaybookInfoListType()
            if self.properties.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO) is not None:
                for index_1 in range(len(self.properties.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO))):
                    obj_2 = vnc_api.PlaybookInfoType()
                    if self.properties.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO, {})[index_1].get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_PLAYBOOK_URI) is not None:
                        obj_2.set_playbook_uri(self.properties.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO, {})[index_1].get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_PLAYBOOK_URI))
                    if self.properties.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO, {})[index_1].get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_MULTI_DEVICE_PLAYBOOK) is not None:
                        obj_2.set_multi_device_playbook(self.properties.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO, {})[index_1].get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_MULTI_DEVICE_PLAYBOOK))
                    if self.properties.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO, {})[index_1].get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_VENDOR) is not None:
                        obj_2.set_vendor(self.properties.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO, {})[index_1].get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_VENDOR))
                    if self.properties.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO, {})[index_1].get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_DEVICE_FAMILY) is not None:
                        obj_2.set_device_family(self.properties.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO, {})[index_1].get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_DEVICE_FAMILY))
                    if self.properties.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO, {})[index_1].get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_JOB_COMPLETION_WEIGHTAGE) is not None:
                        obj_2.set_job_completion_weightage(self.properties.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO, {})[index_1].get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_JOB_COMPLETION_WEIGHTAGE))
                    if self.properties.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO, {})[index_1].get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_SEQUENCE_NO) is not None:
                        obj_2.set_sequence_no(self.properties.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO, {})[index_1].get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_SEQUENCE_NO))
                    obj_1.add_playbook_info(obj_2)
            obj_0.set_job_template_recovery_playbooks(obj_1)
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        ...
        if prop_diff.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS) is not None:
            obj_1 = vnc_api.PlaybookInfoListType()
            if prop_diff.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO) is not None:
                for index_1 in range(len(prop_diff.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO))):
                    obj_2 = vnc_api.PlaybookInfoType()
                    if prop_diff.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO, {})[index_1].get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_PLAYBOOK_URI) is not None:
                        obj_2.set_playbook_uri(prop_diff.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO, {})[index_1].get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_PLAYBOOK_URI))
                    if prop_diff.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO, {})[index_1].get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_MULTI_DEVICE_PLAYBOOK) is not None:
                        obj_2.set_multi_device_playbook(prop_diff.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO, {})[index_1].get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_MULTI_DEVICE_PLAYBOOK))
                    if prop_diff.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO, {})[index_1].get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_VENDOR) is not None:
                        obj_2.set_vendor(prop_diff.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO, {})[index_1].get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_VENDOR))
                    if prop_diff.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO, {})[index_1].get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_DEVICE_FAMILY) is not None:
                        obj_2.set_device_family(prop_diff.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO, {})[index_1].get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_DEVICE_FAMILY))
                    if prop_diff.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO, {})[index_1].get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_JOB_COMPLETION_WEIGHTAGE) is not None:
                        obj_2.set_job_completion_weightage(prop_diff.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO, {})[index_1].get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_JOB_COMPLETION_WEIGHTAGE))
                    if prop_diff.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO, {})[index_1].get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_SEQUENCE_NO) is not None:
                        obj_2.set_sequence_no(prop_diff.get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS, {}).get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO, {})[index_1].get(self.JOB_TEMPLATE_RECOVERY_PLAYBOOKS_PLAYBOOK_INFO_SEQUENCE_NO))
                    obj_1.add_playbook_info(obj_2)
            obj_0.set_job_template_recovery_playbooks(obj_1)
