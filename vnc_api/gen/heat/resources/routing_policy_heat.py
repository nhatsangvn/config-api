                        ...
                        schema={
                            ...
                            ROUTING_POLICY_ENTRIES_TERM_TERM_ACTION_LIST: properties.Schema(
                                ...
                                schema={
                                    ...
                                    ROUTING_POLICY_ENTRIES_TERM_TERM_ACTION_LIST_ACTION_NEXT_VALUE: properties.Schema(
                                        properties.Schema.STRING,
                                        _('ROUTING_POLICY_ENTRIES_TERM_TERM_ACTION_LIST_ACTION_NEXT_VALUE.'),
                                        update_allowed=True,
                                        required=False,
                                        constraints=[
                                            constraints.AllowedValues([u'term', u'policy']),
                                        ],
                                    ),
            ...
            if self.properties.get(self.ROUTING_POLICY_ENTRIES, {}).get(self.ROUTING_POLICY_ENTRIES_TERM) is not None:
                for index_1 in range(len(self.properties.get(self.ROUTING_POLICY_ENTRIES, {}).get(self.ROUTING_POLICY_ENTRIES_TERM))):
                    ...
                    if self.properties.get(self.ROUTING_POLICY_ENTRIES, {}).get(self.ROUTING_POLICY_ENTRIES_TERM, {})[index_1].get(self.ROUTING_POLICY_ENTRIES_TERM_TERM_ACTION_LIST) is not None:
                        ...
                        if self.properties.get(self.ROUTING_POLICY_ENTRIES, {}).get(self.ROUTING_POLICY_ENTRIES_TERM, {})[index_1].get(self.ROUTING_POLICY_ENTRIES_TERM_TERM_ACTION_LIST, {}).get(self.ROUTING_POLICY_ENTRIES_TERM_TERM_ACTION_LIST_ACTION_NEXT_VALUE) is not None:
                            obj_3.set_action_next_value(self.properties.get(self.ROUTING_POLICY_ENTRIES, {}).get(self.ROUTING_POLICY_ENTRIES_TERM, {})[index_1].get(self.ROUTING_POLICY_ENTRIES_TERM_TERM_ACTION_LIST, {}).get(self.ROUTING_POLICY_ENTRIES_TERM_TERM_ACTION_LIST_ACTION_NEXT_VALUE))
            ...
            if prop_diff.get(self.ROUTING_POLICY_ENTRIES, {}).get(self.ROUTING_POLICY_ENTRIES_TERM) is not None:
                for index_1 in range(len(prop_diff.get(self.ROUTING_POLICY_ENTRIES, {}).get(self.ROUTING_POLICY_ENTRIES_TERM))):
                    ...
                    if prop_diff.get(self.ROUTING_POLICY_ENTRIES, {}).get(self.ROUTING_POLICY_ENTRIES_TERM, {})[index_1].get(self.ROUTING_POLICY_ENTRIES_TERM_TERM_ACTION_LIST) is not None:
                        ...
                        if prop_diff.get(self.ROUTING_POLICY_ENTRIES, {}).get(self.ROUTING_POLICY_ENTRIES_TERM, {})[index_1].get(self.ROUTING_POLICY_ENTRIES_TERM_TERM_ACTION_LIST, {}).get(self.ROUTING_POLICY_ENTRIES_TERM_TERM_ACTION_LIST_ACTION_NEXT_VALUE) is not None:
                            obj_3.set_action_next_value(prop_diff.get(self.ROUTING_POLICY_ENTRIES, {}).get(self.ROUTING_POLICY_ENTRIES_TERM, {})[index_1].get(self.ROUTING_POLICY_ENTRIES_TERM_TERM_ACTION_LIST, {}).get(self.ROUTING_POLICY_ENTRIES_TERM_TERM_ACTION_LIST_ACTION_NEXT_VALUE))
