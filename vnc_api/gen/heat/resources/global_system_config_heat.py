...
class ContrailGlobalSystemConfig(contrail.ContrailResource):
    ...
    properties_schema = {
        ...
        ROUTE_REPLICATION_THRESHOLD: properties.Schema(
            properties.Schema.INTEGER,
            _('ROUTE_REPLICATION_THRESHOLD.'),
            update_allowed=True,
            required=False,
        ),
        ...
        FAST_CONVERGENCE_PARAMETERS: properties.Schema(
            properties.Schema.MAP,
            _('FAST_CONVERGENCE_PARAMETERS.'),
            update_allowed=True,
            required=False,
            schema={
                FAST_CONVERGENCE_PARAMETERS_ENABLE: properties.Schema(
                    properties.Schema.BOOLEAN,
                    _('FAST_CONVERGENCE_PARAMETERS_ENABLE.'),
                    update_allowed=True,
                    required=False,
                ),
                FAST_CONVERGENCE_PARAMETERS_NH_REACHABILITY_CHECK: properties.Schema(
                    properties.Schema.BOOLEAN,
                    _('FAST_CONVERGENCE_PARAMETERS_NH_REACHABILITY_CHECK.'),
                    update_allowed=True,
                    required=False,
                ),
                FAST_CONVERGENCE_PARAMETERS_XMPP_HOLD_TIME: properties.Schema(
                    properties.Schema.INTEGER,
                    _('FAST_CONVERGENCE_PARAMETERS_XMPP_HOLD_TIME.'),
                    update_allowed=True,
                    required=False,
                    constraints=[
                        constraints.Range(1, 90),
                    ],
                ),
            }
        ),
    ...
    attributes_schema = {
        ...
        ROUTE_REPLICATION_THRESHOLD: attributes.Schema(
            _('ROUTE_REPLICATION_THRESHOLD.'),
        ),
        ...
        FAST_CONVERGENCE_PARAMETERS: attributes.Schema(
            _('FAST_CONVERGENCE_PARAMETERS.'),
        ),
    ...
    def handle_create(self):
        ...
        if self.properties.get(self.ROUTE_REPLICATION_THRESHOLD) is not None:
            obj_0.set_route_replication_threshold(self.properties.get(self.ROUTE_REPLICATION_THRESHOLD))
        ...
        if self.properties.get(self.FAST_CONVERGENCE_PARAMETERS) is not None:
            obj_1 = vnc_api.FastConvergenceParametersType()
            if self.properties.get(self.FAST_CONVERGENCE_PARAMETERS, {}).get(self.FAST_CONVERGENCE_PARAMETERS_ENABLE) is not None:
                obj_1.set_enable(self.properties.get(self.FAST_CONVERGENCE_PARAMETERS, {}).get(self.FAST_CONVERGENCE_PARAMETERS_ENABLE))
            if self.properties.get(self.FAST_CONVERGENCE_PARAMETERS, {}).get(self.FAST_CONVERGENCE_PARAMETERS_NH_REACHABILITY_CHECK) is not None:
                obj_1.set_nh_reachability_check(self.properties.get(self.FAST_CONVERGENCE_PARAMETERS, {}).get(self.FAST_CONVERGENCE_PARAMETERS_NH_REACHABILITY_CHECK))
            if self.properties.get(self.FAST_CONVERGENCE_PARAMETERS, {}).get(self.FAST_CONVERGENCE_PARAMETERS_XMPP_HOLD_TIME) is not None:
                obj_1.set_xmpp_hold_time(self.properties.get(self.FAST_CONVERGENCE_PARAMETERS, {}).get(self.FAST_CONVERGENCE_PARAMETERS_XMPP_HOLD_TIME))
            obj_0.set_fast_convergence_parameters(obj_1)
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        ...
        if prop_diff.get(self.ROUTE_REPLICATION_THRESHOLD) is not None:
            obj_0.set_route_replication_threshold(prop_diff.get(self.ROUTE_REPLICATION_THRESHOLD))
        ...
        if prop_diff.get(self.ID_PERMS) is not None:
            ...
            obj_0.set_id_perms(obj_1)
        if prop_diff.get(self.FAST_CONVERGENCE_PARAMETERS) is not None:
            obj_1 = vnc_api.FastConvergenceParametersType()
            if prop_diff.get(self.FAST_CONVERGENCE_PARAMETERS, {}).get(self.FAST_CONVERGENCE_PARAMETERS_ENABLE) is not None:
                obj_1.set_enable(prop_diff.get(self.FAST_CONVERGENCE_PARAMETERS, {}).get(self.FAST_CONVERGENCE_PARAMETERS_ENABLE))
            if prop_diff.get(self.FAST_CONVERGENCE_PARAMETERS, {}).get(self.FAST_CONVERGENCE_PARAMETERS_NH_REACHABILITY_CHECK) is not None:
                obj_1.set_nh_reachability_check(prop_diff.get(self.FAST_CONVERGENCE_PARAMETERS, {}).get(self.FAST_CONVERGENCE_PARAMETERS_NH_REACHABILITY_CHECK))
            if prop_diff.get(self.FAST_CONVERGENCE_PARAMETERS, {}).get(self.FAST_CONVERGENCE_PARAMETERS_XMPP_HOLD_TIME) is not None:
                obj_1.set_xmpp_hold_time(prop_diff.get(self.FAST_CONVERGENCE_PARAMETERS, {}).get(self.FAST_CONVERGENCE_PARAMETERS_XMPP_HOLD_TIME))
            obj_0.set_fast_convergence_parameters(obj_1)
