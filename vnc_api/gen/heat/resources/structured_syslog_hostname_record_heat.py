...
class ContrailStructuredSyslogHostnameRecord(contrail.ContrailResource):
    PROPERTIES = (
        NAME, FQ_NAME, STRUCTURED_SYSLOG_LAN_SEGMENT_LIST, STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST, STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST_VPN, STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST_NETWORK_RANGES, DISPLAY_NAME, STRUCTURED_SYSLOG_HOSTADDR, STRUCTURED_SYSLOG_DEVICE, STRUCTURED_SYSLOG_LINKMAP, STRUCTURED_SYSLOG_LINKMAP_LINKS, STRUCTURED_SYSLOG_LINKMAP_LINKS_OVERLAY, STRUCTURED_SYSLOG_LINKMAP_LINKS_UNDERLAY, STRUCTURED_SYSLOG_LINKMAP_LINKS_LINK_TYPE, STRUCTURED_SYSLOG_LINKMAP_LINKS_TRAFFIC_DESTINATION, STRUCTURED_SYSLOG_LINKMAP_LINKS_METADATA, PERMS2, PERMS2_OWNER, PERMS2_OWNER_ACCESS, PERMS2_GLOBAL_ACCESS, PERMS2_SHARE, PERMS2_SHARE_TENANT, PERMS2_SHARE_TENANT_ACCESS, ID_PERMS, ID_PERMS_PERMISSIONS, ID_PERMS_PERMISSIONS_OWNER, ID_PERMS_PERMISSIONS_OWNER_ACCESS, ID_PERMS_PERMISSIONS_GROUP, ID_PERMS_PERMISSIONS_GROUP_ACCESS, ID_PERMS_PERMISSIONS_OTHER_ACCESS, ID_PERMS_UUID, ID_PERMS_UUID_UUID_MSLONG, ID_PERMS_UUID_UUID_LSLONG, ID_PERMS_ENABLE, ID_PERMS_CREATED, ID_PERMS_LAST_MODIFIED, ID_PERMS_DESCRIPTION, ID_PERMS_USER_VISIBLE, ID_PERMS_CREATOR, STRUCTURED_SYSLOG_LOCATION, STRUCTURED_SYSLOG_HOSTNAME_TAGS, ANNOTATIONS, ANNOTATIONS_KEY_VALUE_PAIR, ANNOTATIONS_KEY_VALUE_PAIR_KEY, ANNOTATIONS_KEY_VALUE_PAIR_VALUE, STRUCTURED_SYSLOG_TENANT, TAG_REFS, STRUCTURED_SYSLOG_CONFIG
    ) = (
        'name', 'fq_name', 'structured_syslog_lan_segment_list', 'structured_syslog_lan_segment_list_LANSegmentList', 'structured_syslog_lan_segment_list_LANSegmentList_vpn', 'structured_syslog_lan_segment_list_LANSegmentList_network_ranges', 'display_name', 'structured_syslog_hostaddr', 'structured_syslog_device', 'structured_syslog_linkmap', 'structured_syslog_linkmap_links', 'structured_syslog_linkmap_links_overlay', 'structured_syslog_linkmap_links_underlay', 'structured_syslog_linkmap_links_link_type', 'structured_syslog_linkmap_links_traffic_destination', 'structured_syslog_linkmap_links_metadata', 'perms2', 'perms2_owner', 'perms2_owner_access', 'perms2_global_access', 'perms2_share', 'perms2_share_tenant', 'perms2_share_tenant_access', 'id_perms', 'id_perms_permissions', 'id_perms_permissions_owner', 'id_perms_permissions_owner_access', 'id_perms_permissions_group', 'id_perms_permissions_group_access', 'id_perms_permissions_other_access', 'id_perms_uuid', 'id_perms_uuid_uuid_mslong', 'id_perms_uuid_uuid_lslong', 'id_perms_enable', 'id_perms_created', 'id_perms_last_modified', 'id_perms_description', 'id_perms_user_visible', 'id_perms_creator', 'structured_syslog_location', 'structured_syslog_hostname_tags', 'annotations', 'annotations_key_value_pair', 'annotations_key_value_pair_key', 'annotations_key_value_pair_value', 'structured_syslog_tenant', 'tag_refs', 'structured_syslog_config'
    )
    ...
    properties_schema = {
        ...
        STRUCTURED_SYSLOG_LAN_SEGMENT_LIST: properties.Schema(
            properties.Schema.MAP,
            _('STRUCTURED_SYSLOG_LAN_SEGMENT_LIST.'),
            update_allowed=True,
            required=False,
            schema={
                STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST: properties.Schema(
                    properties.Schema.LIST,
                    _('STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST.'),
                    update_allowed=True,
                    required=False,
                    schema=properties.Schema(
                        properties.Schema.MAP,
                        schema={
                            STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST_VPN: properties.Schema(
                                properties.Schema.STRING,
                                _('STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST_VPN.'),
                                update_allowed=True,
                                required=False,
                            ),
                            STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST_NETWORK_RANGES: properties.Schema(
                                properties.Schema.STRING,
                                _('STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST_NETWORK_RANGES.'),
                                update_allowed=True,
                                required=False,
                            ),
                        }
                ...
                STRUCTURED_SYSLOG_LINKMAP_LINKS: properties.Schema(
                    ...
                    schema=properties.Schema(
                        ...
                        schema={
                            ...
                            STRUCTURED_SYSLOG_LINKMAP_LINKS_LINK_TYPE: properties.Schema(
                                properties.Schema.STRING,
                                _('STRUCTURED_SYSLOG_LINKMAP_LINKS_LINK_TYPE.'),
                                update_allowed=True,
                                required=False,
                            ),
                            STRUCTURED_SYSLOG_LINKMAP_LINKS_TRAFFIC_DESTINATION: properties.Schema(
                                properties.Schema.STRING,
                                _('STRUCTURED_SYSLOG_LINKMAP_LINKS_TRAFFIC_DESTINATION.'),
                                update_allowed=True,
                                required=False,
                            ),
                            STRUCTURED_SYSLOG_LINKMAP_LINKS_METADATA: properties.Schema(
                                properties.Schema.STRING,
                                _('STRUCTURED_SYSLOG_LINKMAP_LINKS_METADATA.'),
                                update_allowed=True,
                                required=False,
                            ),
                        }
    ...
    attributes_schema = {
        ...
        STRUCTURED_SYSLOG_LAN_SEGMENT_LIST: attributes.Schema(
            _('STRUCTURED_SYSLOG_LAN_SEGMENT_LIST.'),
        ),
    ...
    def handle_create(self):
        ...
        if self.properties.get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST) is not None:
            obj_1 = vnc_api.StructuredSyslogLANSegmentList()
            if self.properties.get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST, {}).get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST) is not None:
                for index_1 in range(len(self.properties.get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST, {}).get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST))):
                    obj_2 = vnc_api.StructuredSyslogLANSegmentType()
                    if self.properties.get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST, {}).get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST, {})[index_1].get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST_VPN) is not None:
                        obj_2.set_vpn(self.properties.get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST, {}).get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST, {})[index_1].get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST_VPN))
                    if self.properties.get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST, {}).get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST, {})[index_1].get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST_NETWORK_RANGES) is not None:
                        obj_2.set_network_ranges(self.properties.get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST, {}).get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST, {})[index_1].get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST_NETWORK_RANGES))
                    obj_1.add_LANSegmentList(obj_2)
            obj_0.set_structured_syslog_lan_segment_list(obj_1)
        ...
        if self.properties.get(self.STRUCTURED_SYSLOG_LINKMAP) is not None:
            ...
            if self.properties.get(self.STRUCTURED_SYSLOG_LINKMAP, {}).get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS) is not None:
                for index_1 in range(len(self.properties.get(self.STRUCTURED_SYSLOG_LINKMAP, {}).get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS))):
                    ...
                    if self.properties.get(self.STRUCTURED_SYSLOG_LINKMAP, {}).get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS, {})[index_1].get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS_LINK_TYPE) is not None:
                        obj_2.set_link_type(self.properties.get(self.STRUCTURED_SYSLOG_LINKMAP, {}).get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS, {})[index_1].get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS_LINK_TYPE))
                    if self.properties.get(self.STRUCTURED_SYSLOG_LINKMAP, {}).get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS, {})[index_1].get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS_TRAFFIC_DESTINATION) is not None:
                        obj_2.set_traffic_destination(self.properties.get(self.STRUCTURED_SYSLOG_LINKMAP, {}).get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS, {})[index_1].get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS_TRAFFIC_DESTINATION))
                    if self.properties.get(self.STRUCTURED_SYSLOG_LINKMAP, {}).get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS, {})[index_1].get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS_METADATA) is not None:
                        obj_2.set_metadata(self.properties.get(self.STRUCTURED_SYSLOG_LINKMAP, {}).get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS, {})[index_1].get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS_METADATA))
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        ...
        if prop_diff.get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST) is not None:
            obj_1 = vnc_api.StructuredSyslogLANSegmentList()
            if prop_diff.get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST, {}).get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST) is not None:
                for index_1 in range(len(prop_diff.get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST, {}).get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST))):
                    obj_2 = vnc_api.StructuredSyslogLANSegmentType()
                    if prop_diff.get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST, {}).get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST, {})[index_1].get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST_VPN) is not None:
                        obj_2.set_vpn(prop_diff.get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST, {}).get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST, {})[index_1].get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST_VPN))
                    if prop_diff.get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST, {}).get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST, {})[index_1].get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST_NETWORK_RANGES) is not None:
                        obj_2.set_network_ranges(prop_diff.get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST, {}).get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST, {})[index_1].get(self.STRUCTURED_SYSLOG_LAN_SEGMENT_LIST_LANSEGMENTLIST_NETWORK_RANGES))
                    obj_1.add_LANSegmentList(obj_2)
            obj_0.set_structured_syslog_lan_segment_list(obj_1)
        ...
        if prop_diff.get(self.STRUCTURED_SYSLOG_LINKMAP) is not None:
            ...
            if prop_diff.get(self.STRUCTURED_SYSLOG_LINKMAP, {}).get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS) is not None:
                for index_1 in range(len(prop_diff.get(self.STRUCTURED_SYSLOG_LINKMAP, {}).get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS))):
                    ...
                    if prop_diff.get(self.STRUCTURED_SYSLOG_LINKMAP, {}).get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS, {})[index_1].get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS_LINK_TYPE) is not None:
                        obj_2.set_link_type(prop_diff.get(self.STRUCTURED_SYSLOG_LINKMAP, {}).get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS, {})[index_1].get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS_LINK_TYPE))
                    if prop_diff.get(self.STRUCTURED_SYSLOG_LINKMAP, {}).get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS, {})[index_1].get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS_TRAFFIC_DESTINATION) is not None:
                        obj_2.set_traffic_destination(prop_diff.get(self.STRUCTURED_SYSLOG_LINKMAP, {}).get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS, {})[index_1].get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS_TRAFFIC_DESTINATION))
                    if prop_diff.get(self.STRUCTURED_SYSLOG_LINKMAP, {}).get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS, {})[index_1].get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS_METADATA) is not None:
                        obj_2.set_metadata(prop_diff.get(self.STRUCTURED_SYSLOG_LINKMAP, {}).get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS, {})[index_1].get(self.STRUCTURED_SYSLOG_LINKMAP_LINKS_METADATA))
                    obj_1.add_links(obj_2)
            obj_0.set_structured_syslog_linkmap(obj_1)
