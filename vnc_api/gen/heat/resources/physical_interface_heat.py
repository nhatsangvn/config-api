...
class ContrailPhysicalInterface(contrail.ContrailResource):
    PROPERTIES = (
        NAME, FQ_NAME, DISPLAY_NAME, PHYSICAL_INTERFACE_MAC_ADDRESSES, PHYSICAL_INTERFACE_MAC_ADDRESSES_MAC_ADDRESS, ETHERNET_SEGMENT_IDENTIFIER, PHYSICAL_INTERFACE_PORT_PARAMS, PHYSICAL_INTERFACE_PORT_PARAMS_PORT_DISABLE, PHYSICAL_INTERFACE_PORT_PARAMS_PORT_MTU, PHYSICAL_INTERFACE_PORT_PARAMS_PORT_DESCRIPTION, ANNOTATIONS, ANNOTATIONS_KEY_VALUE_PAIR, ANNOTATIONS_KEY_VALUE_PAIR_KEY, ANNOTATIONS_KEY_VALUE_PAIR_VALUE, PERMS2, PERMS2_OWNER, PERMS2_OWNER_ACCESS, PERMS2_GLOBAL_ACCESS, PERMS2_SHARE, PERMS2_SHARE_TENANT, PERMS2_SHARE_TENANT_ACCESS, ID_PERMS, ID_PERMS_PERMISSIONS, ID_PERMS_PERMISSIONS_OWNER, ID_PERMS_PERMISSIONS_OWNER_ACCESS, ID_PERMS_PERMISSIONS_GROUP, ID_PERMS_PERMISSIONS_GROUP_ACCESS, ID_PERMS_PERMISSIONS_OTHER_ACCESS, ID_PERMS_UUID, ID_PERMS_UUID_UUID_MSLONG, ID_PERMS_UUID_UUID_LSLONG, ID_PERMS_ENABLE, ID_PERMS_CREATED, ID_PERMS_LAST_MODIFIED, ID_PERMS_DESCRIPTION, ID_PERMS_USER_VISIBLE, ID_PERMS_CREATOR, PHYSICAL_INTERFACE_LACP_FORCE_UP, PHYSICAL_INTERFACE_PORT_ID, PHYSICAL_INTERFACE_TYPE, PHYSICAL_INTERFACE_FLOW_CONTROL, TAG_REFS, PORT_REFS, PHYSICAL_INTERFACE_REFS, PHYSICAL_ROUTER
    ) = (
        'name', 'fq_name', 'display_name', 'physical_interface_mac_addresses', 'physical_interface_mac_addresses_mac_address', 'ethernet_segment_identifier', 'physical_interface_port_params', 'physical_interface_port_params_port_disable', 'physical_interface_port_params_port_mtu', 'physical_interface_port_params_port_description', 'annotations', 'annotations_key_value_pair', 'annotations_key_value_pair_key', 'annotations_key_value_pair_value', 'perms2', 'perms2_owner', 'perms2_owner_access', 'perms2_global_access', 'perms2_share', 'perms2_share_tenant', 'perms2_share_tenant_access', 'id_perms', 'id_perms_permissions', 'id_perms_permissions_owner', 'id_perms_permissions_owner_access', 'id_perms_permissions_group', 'id_perms_permissions_group_access', 'id_perms_permissions_other_access', 'id_perms_uuid', 'id_perms_uuid_uuid_mslong', 'id_perms_uuid_uuid_lslong', 'id_perms_enable', 'id_perms_created', 'id_perms_last_modified', 'id_perms_description', 'id_perms_user_visible', 'id_perms_creator', 'physical_interface_lacp_force_up', 'physical_interface_port_id', 'physical_interface_type', 'physical_interface_flow_control', 'tag_refs', 'port_refs', 'physical_interface_refs', 'physical_router'
    )
    ...
    properties_schema = {
        ...
        PHYSICAL_INTERFACE_PORT_PARAMS: properties.Schema(
            properties.Schema.MAP,
            _('PHYSICAL_INTERFACE_PORT_PARAMS.'),
            update_allowed=True,
            required=False,
            schema={
                PHYSICAL_INTERFACE_PORT_PARAMS_PORT_DISABLE: properties.Schema(
                    properties.Schema.BOOLEAN,
                    _('PHYSICAL_INTERFACE_PORT_PARAMS_PORT_DISABLE.'),
                    update_allowed=True,
                    required=False,
                ),
                PHYSICAL_INTERFACE_PORT_PARAMS_PORT_MTU: properties.Schema(
                    properties.Schema.INTEGER,
                    _('PHYSICAL_INTERFACE_PORT_PARAMS_PORT_MTU.'),
                    update_allowed=True,
                    required=False,
                    constraints=[
                ...
                PHYSICAL_INTERFACE_PORT_PARAMS_PORT_DESCRIPTION: properties.Schema(
                    properties.Schema.STRING,
                    _('PHYSICAL_INTERFACE_PORT_PARAMS_PORT_DESCRIPTION.'),
                    update_allowed=True,
                    required=False,
                ),
            }
        ...
        PHYSICAL_INTERFACE_LACP_FORCE_UP: properties.Schema(
            properties.Schema.BOOLEAN,
            _('PHYSICAL_INTERFACE_LACP_FORCE_UP.'),
            update_allowed=True,
            required=False,
        ),
        ...
        PHYSICAL_INTERFACE_FLOW_CONTROL: properties.Schema(
            properties.Schema.BOOLEAN,
            _('PHYSICAL_INTERFACE_FLOW_CONTROL.'),
            update_allowed=True,
            required=False,
        ),
    ...
    attributes_schema = {
        ...
        PHYSICAL_INTERFACE_PORT_PARAMS: attributes.Schema(
            _('PHYSICAL_INTERFACE_PORT_PARAMS.'),
        ),
        ...
        PHYSICAL_INTERFACE_LACP_FORCE_UP: attributes.Schema(
            _('PHYSICAL_INTERFACE_LACP_FORCE_UP.'),
        ),
        ...
        PHYSICAL_INTERFACE_FLOW_CONTROL: attributes.Schema(
            _('PHYSICAL_INTERFACE_FLOW_CONTROL.'),
        ),
    ...
    def handle_create(self):
        ...
        if self.properties.get(self.PHYSICAL_INTERFACE_PORT_PARAMS) is not None:
            obj_1 = vnc_api.PortParameters()
            if self.properties.get(self.PHYSICAL_INTERFACE_PORT_PARAMS, {}).get(self.PHYSICAL_INTERFACE_PORT_PARAMS_PORT_DISABLE) is not None:
                obj_1.set_port_disable(self.properties.get(self.PHYSICAL_INTERFACE_PORT_PARAMS, {}).get(self.PHYSICAL_INTERFACE_PORT_PARAMS_PORT_DISABLE))
            if self.properties.get(self.PHYSICAL_INTERFACE_PORT_PARAMS, {}).get(self.PHYSICAL_INTERFACE_PORT_PARAMS_PORT_MTU) is not None:
                obj_1.set_port_mtu(self.properties.get(self.PHYSICAL_INTERFACE_PORT_PARAMS, {}).get(self.PHYSICAL_INTERFACE_PORT_PARAMS_PORT_MTU))
            if self.properties.get(self.PHYSICAL_INTERFACE_PORT_PARAMS, {}).get(self.PHYSICAL_INTERFACE_PORT_PARAMS_PORT_DESCRIPTION) is not None:
                obj_1.set_port_description(self.properties.get(self.PHYSICAL_INTERFACE_PORT_PARAMS, {}).get(self.PHYSICAL_INTERFACE_PORT_PARAMS_PORT_DESCRIPTION))
            obj_0.set_physical_interface_port_params(obj_1)
        ...
        if self.properties.get(self.PHYSICAL_INTERFACE_LACP_FORCE_UP) is not None:
            obj_0.set_physical_interface_lacp_force_up(self.properties.get(self.PHYSICAL_INTERFACE_LACP_FORCE_UP))
        ...
        if self.properties.get(self.PHYSICAL_INTERFACE_FLOW_CONTROL) is not None:
            obj_0.set_physical_interface_flow_control(self.properties.get(self.PHYSICAL_INTERFACE_FLOW_CONTROL))
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        ...
        if prop_diff.get(self.PHYSICAL_INTERFACE_PORT_PARAMS) is not None:
            obj_1 = vnc_api.PortParameters()
            if prop_diff.get(self.PHYSICAL_INTERFACE_PORT_PARAMS, {}).get(self.PHYSICAL_INTERFACE_PORT_PARAMS_PORT_DISABLE) is not None:
                obj_1.set_port_disable(prop_diff.get(self.PHYSICAL_INTERFACE_PORT_PARAMS, {}).get(self.PHYSICAL_INTERFACE_PORT_PARAMS_PORT_DISABLE))
            if prop_diff.get(self.PHYSICAL_INTERFACE_PORT_PARAMS, {}).get(self.PHYSICAL_INTERFACE_PORT_PARAMS_PORT_MTU) is not None:
                obj_1.set_port_mtu(prop_diff.get(self.PHYSICAL_INTERFACE_PORT_PARAMS, {}).get(self.PHYSICAL_INTERFACE_PORT_PARAMS_PORT_MTU))
            if prop_diff.get(self.PHYSICAL_INTERFACE_PORT_PARAMS, {}).get(self.PHYSICAL_INTERFACE_PORT_PARAMS_PORT_DESCRIPTION) is not None:
                obj_1.set_port_description(prop_diff.get(self.PHYSICAL_INTERFACE_PORT_PARAMS, {}).get(self.PHYSICAL_INTERFACE_PORT_PARAMS_PORT_DESCRIPTION))
            obj_0.set_physical_interface_port_params(obj_1)
        ...
        if prop_diff.get(self.ID_PERMS) is not None:
            ...
            obj_0.set_id_perms(obj_1)
        if prop_diff.get(self.PHYSICAL_INTERFACE_LACP_FORCE_UP) is not None:
            obj_0.set_physical_interface_lacp_force_up(prop_diff.get(self.PHYSICAL_INTERFACE_LACP_FORCE_UP))
        ...
        if prop_diff.get(self.PHYSICAL_INTERFACE_FLOW_CONTROL) is not None:
            obj_0.set_physical_interface_flow_control(prop_diff.get(self.PHYSICAL_INTERFACE_FLOW_CONTROL))
