...
class ContrailLogicalInterface(contrail.ContrailResource):
    ...
    properties_schema = {
        ...
        LOGICAL_INTERFACE_PORT_PARAMS: properties.Schema(
            properties.Schema.MAP,
            _('LOGICAL_INTERFACE_PORT_PARAMS.'),
            update_allowed=True,
            required=False,
            schema={
                LOGICAL_INTERFACE_PORT_PARAMS_PORT_DISABLE: properties.Schema(
                    properties.Schema.BOOLEAN,
                    _('LOGICAL_INTERFACE_PORT_PARAMS_PORT_DISABLE.'),
                    update_allowed=True,
                    required=False,
                ),
                LOGICAL_INTERFACE_PORT_PARAMS_PORT_MTU: properties.Schema(
                    properties.Schema.INTEGER,
                    _('LOGICAL_INTERFACE_PORT_PARAMS_PORT_MTU.'),
                    update_allowed=True,
                    required=False,
                    constraints=[
                ...
                LOGICAL_INTERFACE_PORT_PARAMS_PORT_DESCRIPTION: properties.Schema(
                    properties.Schema.STRING,
                    _('LOGICAL_INTERFACE_PORT_PARAMS_PORT_DESCRIPTION.'),
                    update_allowed=True,
                    required=False,
                ),
            }
    ...
    attributes_schema = {
        ...
        LOGICAL_INTERFACE_PORT_PARAMS: attributes.Schema(
            _('LOGICAL_INTERFACE_PORT_PARAMS.'),
        ),
    ...
    def handle_create(self):
        ...
        if self.properties.get(self.LOGICAL_INTERFACE_PORT_PARAMS) is not None:
            obj_1 = vnc_api.PortParameters()
            if self.properties.get(self.LOGICAL_INTERFACE_PORT_PARAMS, {}).get(self.LOGICAL_INTERFACE_PORT_PARAMS_PORT_DISABLE) is not None:
                obj_1.set_port_disable(self.properties.get(self.LOGICAL_INTERFACE_PORT_PARAMS, {}).get(self.LOGICAL_INTERFACE_PORT_PARAMS_PORT_DISABLE))
            if self.properties.get(self.LOGICAL_INTERFACE_PORT_PARAMS, {}).get(self.LOGICAL_INTERFACE_PORT_PARAMS_PORT_MTU) is not None:
                obj_1.set_port_mtu(self.properties.get(self.LOGICAL_INTERFACE_PORT_PARAMS, {}).get(self.LOGICAL_INTERFACE_PORT_PARAMS_PORT_MTU))
            if self.properties.get(self.LOGICAL_INTERFACE_PORT_PARAMS, {}).get(self.LOGICAL_INTERFACE_PORT_PARAMS_PORT_DESCRIPTION) is not None:
                obj_1.set_port_description(self.properties.get(self.LOGICAL_INTERFACE_PORT_PARAMS, {}).get(self.LOGICAL_INTERFACE_PORT_PARAMS_PORT_DESCRIPTION))
            obj_0.set_logical_interface_port_params(obj_1)
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        ...
        if prop_diff.get(self.LOGICAL_INTERFACE_PORT_PARAMS) is not None:
            obj_1 = vnc_api.PortParameters()
            if prop_diff.get(self.LOGICAL_INTERFACE_PORT_PARAMS, {}).get(self.LOGICAL_INTERFACE_PORT_PARAMS_PORT_DISABLE) is not None:
                obj_1.set_port_disable(prop_diff.get(self.LOGICAL_INTERFACE_PORT_PARAMS, {}).get(self.LOGICAL_INTERFACE_PORT_PARAMS_PORT_DISABLE))
            if prop_diff.get(self.LOGICAL_INTERFACE_PORT_PARAMS, {}).get(self.LOGICAL_INTERFACE_PORT_PARAMS_PORT_MTU) is not None:
                obj_1.set_port_mtu(prop_diff.get(self.LOGICAL_INTERFACE_PORT_PARAMS, {}).get(self.LOGICAL_INTERFACE_PORT_PARAMS_PORT_MTU))
            if prop_diff.get(self.LOGICAL_INTERFACE_PORT_PARAMS, {}).get(self.LOGICAL_INTERFACE_PORT_PARAMS_PORT_DESCRIPTION) is not None:
                obj_1.set_port_description(prop_diff.get(self.LOGICAL_INTERFACE_PORT_PARAMS, {}).get(self.LOGICAL_INTERFACE_PORT_PARAMS_PORT_DESCRIPTION))
            obj_0.set_logical_interface_port_params(obj_1)
