...
class ContrailVirtualNetwork(contrail.ContrailResource):
    ...
    properties_schema = {
        ...
        VIRTUAL_NETWORK_PROPERTIES: properties.Schema(
            ...
            schema={
                ...
                VIRTUAL_NETWORK_PROPERTIES_MTU: properties.Schema(
                    properties.Schema.INTEGER,
                    _('VIRTUAL_NETWORK_PROPERTIES_MTU.'),
                    update_allowed=True,
                    required=False,
                    constraints=[
                        constraints.Range(64, 9216),
                    ],
                ),
            }
        ),
        ...
        MAC_IP_LEARNING_ENABLE: properties.Schema(
            properties.Schema.BOOLEAN,
            _('MAC_IP_LEARNING_ENABLE.'),
            update_allowed=True,
            required=False,
        ),
    ...
    attributes_schema = {
        ...
        MAC_IP_LEARNING_ENABLE: attributes.Schema(
            _('MAC_IP_LEARNING_ENABLE.'),
        ),
    ...
    def handle_create(self):
        ...
        if self.properties.get(self.VIRTUAL_NETWORK_PROPERTIES) is not None:
            ...
            if self.properties.get(self.VIRTUAL_NETWORK_PROPERTIES, {}).get(self.VIRTUAL_NETWORK_PROPERTIES_MTU) is not None:
                obj_1.set_mtu(self.properties.get(self.VIRTUAL_NETWORK_PROPERTIES, {}).get(self.VIRTUAL_NETWORK_PROPERTIES_MTU))
        ...
        if self.properties.get(self.MAC_IP_LEARNING_ENABLE) is not None:
            obj_0.set_mac_ip_learning_enable(self.properties.get(self.MAC_IP_LEARNING_ENABLE))
        if self.properties.get(self.MTU) is not None:
            obj_0.set_mtu(self.properties.get(self.MTU))
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        ...
        if prop_diff.get(self.VIRTUAL_NETWORK_PROPERTIES) is not None:
            ...
            if prop_diff.get(self.VIRTUAL_NETWORK_PROPERTIES, {}).get(self.VIRTUAL_NETWORK_PROPERTIES_MTU) is not None:
                obj_1.set_mtu(prop_diff.get(self.VIRTUAL_NETWORK_PROPERTIES, {}).get(self.VIRTUAL_NETWORK_PROPERTIES_MTU))
            obj_0.set_virtual_network_properties(obj_1)
        ...
        if prop_diff.get(self.MAC_IP_LEARNING_ENABLE) is not None:
            obj_0.set_mac_ip_learning_enable(prop_diff.get(self.MAC_IP_LEARNING_ENABLE))
        if prop_diff.get(self.MTU) is not None:
            obj_0.set_mtu(prop_diff.get(self.MTU))
