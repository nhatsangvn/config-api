...
class ContrailFirewallRule(contrail.ContrailResource):
    ...
    properties_schema = {
        ...
        ACTION_LIST: properties.Schema(
            ...
            schema={
                ...
                ACTION_LIST_SERVICE_PROPERTIES: properties.Schema(
                    properties.Schema.MAP,
                    _('ACTION_LIST_SERVICE_PROPERTIES.'),
                    update_allowed=True,
                    required=False,
                    schema={
                        ACTION_LIST_SERVICE_PROPERTIES_RETAIN_AS_PATH: properties.Schema(
                            properties.Schema.BOOLEAN,
                            _('ACTION_LIST_SERVICE_PROPERTIES_RETAIN_AS_PATH.'),
                            update_allowed=True,
                            required=False,
                        ),
                    }
    ...
    def handle_create(self):
        ...
        if self.properties.get(self.ACTION_LIST) is not None:
            ...
            if self.properties.get(self.ACTION_LIST, {}).get(self.ACTION_LIST_SERVICE_PROPERTIES) is not None:
                obj_2 = vnc_api.ServicePropertiesType()
                if self.properties.get(self.ACTION_LIST, {}).get(self.ACTION_LIST_SERVICE_PROPERTIES, {}).get(self.ACTION_LIST_SERVICE_PROPERTIES_RETAIN_AS_PATH) is not None:
                    obj_2.set_retain_as_path(self.properties.get(self.ACTION_LIST, {}).get(self.ACTION_LIST_SERVICE_PROPERTIES, {}).get(self.ACTION_LIST_SERVICE_PROPERTIES_RETAIN_AS_PATH))
                obj_1.set_service_properties(obj_2)
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        ...
        if prop_diff.get(self.ACTION_LIST) is not None:
            ...
            if prop_diff.get(self.ACTION_LIST, {}).get(self.ACTION_LIST_SERVICE_PROPERTIES) is not None:
                obj_2 = vnc_api.ServicePropertiesType()
                if prop_diff.get(self.ACTION_LIST, {}).get(self.ACTION_LIST_SERVICE_PROPERTIES, {}).get(self.ACTION_LIST_SERVICE_PROPERTIES_RETAIN_AS_PATH) is not None:
                    obj_2.set_retain_as_path(prop_diff.get(self.ACTION_LIST, {}).get(self.ACTION_LIST_SERVICE_PROPERTIES, {}).get(self.ACTION_LIST_SERVICE_PROPERTIES_RETAIN_AS_PATH))
                obj_1.set_service_properties(obj_2)
