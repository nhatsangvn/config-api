                        ...
                        schema={
                            ...
                            SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST: properties.Schema(
                                ...
                                schema={
                                    ...
                                    SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES: properties.Schema(
                                        properties.Schema.MAP,
                                        _('SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES.'),
                                        update_allowed=True,
                                        required=False,
                                        schema={
                                            SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES_RETAIN_AS_PATH: properties.Schema(
                                                properties.Schema.BOOLEAN,
                                                _('SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES_RETAIN_AS_PATH.'),
                                                update_allowed=True,
                                                required=False,
                                            ),
                                        }
                            ...
                            SECURITY_GROUP_ENTRIES_POLICY_RULE_DESCRIPTION: properties.Schema(
                                properties.Schema.STRING,
                                _('SECURITY_GROUP_ENTRIES_POLICY_RULE_DESCRIPTION.'),
                                update_allowed=True,
                                required=False,
                            ),
                        }
            ...
            if self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE) is not None:
                for index_1 in range(len(self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE))):
                    ...
                    if self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST) is not None:
                        ...
                        if self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES) is not None:
                            obj_4 = vnc_api.ServicePropertiesType()
                            if self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES_RETAIN_AS_PATH) is not None:
                                obj_4.set_retain_as_path(self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES_RETAIN_AS_PATH))
                            obj_3.set_service_properties(obj_4)
                    ...
                    if self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_DESCRIPTION) is not None:
                        obj_2.set_description(self.properties.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_DESCRIPTION))
            ...
            if prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE) is not None:
                for index_1 in range(len(prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE))):
                    ...
                    if prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST) is not None:
                        ...
                        if prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES) is not None:
                            obj_4 = vnc_api.ServicePropertiesType()
                            if prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES_RETAIN_AS_PATH) is not None:
                                obj_4.set_retain_as_path(prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES_RETAIN_AS_PATH))
                            obj_3.set_service_properties(obj_4)
                    ...
                    if prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_DESCRIPTION) is not None:
                        obj_2.set_description(prop_diff.get(self.SECURITY_GROUP_ENTRIES, {}).get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE, {})[index_1].get(self.SECURITY_GROUP_ENTRIES_POLICY_RULE_DESCRIPTION))
                    obj_1.add_policy_rule(obj_2)
            obj_0.set_security_group_entries(obj_1)
