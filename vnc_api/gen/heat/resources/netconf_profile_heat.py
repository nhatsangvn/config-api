...
class ContrailNetconfProfile(contrail.ContrailResource):
    PROPERTIES = (
        NAME, FQ_NAME, DISPLAY_NAME, NETCONF_PARAMETERS, NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS, NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_PHYSICAL_HEALTH, NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_INTERFACE_HEALTH, NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_CONTROL_PLANE_HEALTH, NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_SERVICE_LAYER_HEALTH, PERMS2, PERMS2_OWNER, PERMS2_OWNER_ACCESS, PERMS2_GLOBAL_ACCESS, PERMS2_SHARE, PERMS2_SHARE_TENANT, PERMS2_SHARE_TENANT_ACCESS, ID_PERMS, ID_PERMS_PERMISSIONS, ID_PERMS_PERMISSIONS_OWNER, ID_PERMS_PERMISSIONS_OWNER_ACCESS, ID_PERMS_PERMISSIONS_GROUP, ID_PERMS_PERMISSIONS_GROUP_ACCESS, ID_PERMS_PERMISSIONS_OTHER_ACCESS, ID_PERMS_UUID, ID_PERMS_UUID_UUID_MSLONG, ID_PERMS_UUID_UUID_LSLONG, ID_PERMS_ENABLE, ID_PERMS_CREATED, ID_PERMS_LAST_MODIFIED, ID_PERMS_DESCRIPTION, ID_PERMS_USER_VISIBLE, ID_PERMS_CREATOR, NETCONF_PROFILE_IS_DEFAULT, ANNOTATIONS, ANNOTATIONS_KEY_VALUE_PAIR, ANNOTATIONS_KEY_VALUE_PAIR_KEY, ANNOTATIONS_KEY_VALUE_PAIR_VALUE, TAG_REFS, PROJECT
    ) = (
        'name', 'fq_name', 'display_name', 'netconf_parameters', 'netconf_parameters_enabled_sensor_params', 'netconf_parameters_enabled_sensor_params_physical_health', 'netconf_parameters_enabled_sensor_params_interface_health', 'netconf_parameters_enabled_sensor_params_control_plane_health', 'netconf_parameters_enabled_sensor_params_service_layer_health', 'perms2', 'perms2_owner', 'perms2_owner_access', 'perms2_global_access', 'perms2_share', 'perms2_share_tenant', 'perms2_share_tenant_access', 'id_perms', 'id_perms_permissions', 'id_perms_permissions_owner', 'id_perms_permissions_owner_access', 'id_perms_permissions_group', 'id_perms_permissions_group_access', 'id_perms_permissions_other_access', 'id_perms_uuid', 'id_perms_uuid_uuid_mslong', 'id_perms_uuid_uuid_lslong', 'id_perms_enable', 'id_perms_created', 'id_perms_last_modified', 'id_perms_description', 'id_perms_user_visible', 'id_perms_creator', 'netconf_profile_is_default', 'annotations', 'annotations_key_value_pair', 'annotations_key_value_pair_key', 'annotations_key_value_pair_value', 'tag_refs', 'project'
    )
    ...
    properties_schema = {
        ...
        NETCONF_PARAMETERS: properties.Schema(
            properties.Schema.MAP,
            _('NETCONF_PARAMETERS.'),
            update_allowed=True,
            required=False,
            schema={
                NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS: properties.Schema(
                    properties.Schema.MAP,
                    _('NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS.'),
                    update_allowed=True,
                    required=False,
                    schema={
                        NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_PHYSICAL_HEALTH: properties.Schema(
                            properties.Schema.BOOLEAN,
                            _('NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_PHYSICAL_HEALTH.'),
                            update_allowed=True,
                            required=False,
                        ),
                        NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_INTERFACE_HEALTH: properties.Schema(
                            properties.Schema.BOOLEAN,
                            _('NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_INTERFACE_HEALTH.'),
                            update_allowed=True,
                            required=False,
                        ),
                        NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_CONTROL_PLANE_HEALTH: properties.Schema(
                            properties.Schema.BOOLEAN,
                            _('NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_CONTROL_PLANE_HEALTH.'),
                            update_allowed=True,
                            required=False,
                        ),
                        NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_SERVICE_LAYER_HEALTH: properties.Schema(
                            properties.Schema.BOOLEAN,
                            _('NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_SERVICE_LAYER_HEALTH.'),
                            update_allowed=True,
                            required=False,
                        ),
                    }
        ...
        NETCONF_PROFILE_IS_DEFAULT: properties.Schema(
            properties.Schema.BOOLEAN,
            _('NETCONF_PROFILE_IS_DEFAULT.'),
            update_allowed=True,
            required=False,
        ),
    ...
    attributes_schema = {
        ...
        NETCONF_PARAMETERS: attributes.Schema(
            _('NETCONF_PARAMETERS.'),
        ),
        ...
        NETCONF_PROFILE_IS_DEFAULT: attributes.Schema(
            _('NETCONF_PROFILE_IS_DEFAULT.'),
        ),
    ...
    def handle_create(self):
        ...
        obj_0 = vnc_api.NetconfProfile(name=self.properties[self.NAME],
            parent_obj=parent_obj)

        if self.properties.get(self.DISPLAY_NAME) is not None:
            obj_0.set_display_name(self.properties.get(self.DISPLAY_NAME))
        if self.properties.get(self.NETCONF_PARAMETERS) is not None:
            obj_1 = vnc_api.NetconfParameters()
            if self.properties.get(self.NETCONF_PARAMETERS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS) is not None:
                obj_2 = vnc_api.EnabledSensorParams()
                if self.properties.get(self.NETCONF_PARAMETERS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_PHYSICAL_HEALTH) is not None:
                    obj_2.set_physical_health(self.properties.get(self.NETCONF_PARAMETERS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_PHYSICAL_HEALTH))
                if self.properties.get(self.NETCONF_PARAMETERS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_INTERFACE_HEALTH) is not None:
                    obj_2.set_interface_health(self.properties.get(self.NETCONF_PARAMETERS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_INTERFACE_HEALTH))
                if self.properties.get(self.NETCONF_PARAMETERS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_CONTROL_PLANE_HEALTH) is not None:
                    obj_2.set_control_plane_health(self.properties.get(self.NETCONF_PARAMETERS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_CONTROL_PLANE_HEALTH))
                if self.properties.get(self.NETCONF_PARAMETERS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_SERVICE_LAYER_HEALTH) is not None:
                    obj_2.set_service_layer_health(self.properties.get(self.NETCONF_PARAMETERS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_SERVICE_LAYER_HEALTH))
                obj_1.set_enabled_sensor_params(obj_2)
            obj_0.set_netconf_parameters(obj_1)
        ...
        if self.properties.get(self.NETCONF_PROFILE_IS_DEFAULT) is not None:
            obj_0.set_netconf_profile_is_default(self.properties.get(self.NETCONF_PROFILE_IS_DEFAULT))
        ...
        try:
            obj_uuid = super(ContrailNetconfProfile, self).resource_create(obj_0)
        except Exception as e:
            raise Exception(_('%s') % str(e))
    ...
    def handle_update(self, json_snippet, tmpl_diff, prop_diff):
        try:
            obj_0 = self.vnc_lib().netconf_profile_read(
                id=self.resource_id
            )
        except Exception as e:
            raise Exception(_('%s') % str(e))
        ...
        if prop_diff.get(self.NETCONF_PARAMETERS) is not None:
            obj_1 = vnc_api.NetconfParameters()
            if prop_diff.get(self.NETCONF_PARAMETERS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS) is not None:
                obj_2 = vnc_api.EnabledSensorParams()
                if prop_diff.get(self.NETCONF_PARAMETERS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_PHYSICAL_HEALTH) is not None:
                    obj_2.set_physical_health(prop_diff.get(self.NETCONF_PARAMETERS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_PHYSICAL_HEALTH))
                if prop_diff.get(self.NETCONF_PARAMETERS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_INTERFACE_HEALTH) is not None:
                    obj_2.set_interface_health(prop_diff.get(self.NETCONF_PARAMETERS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_INTERFACE_HEALTH))
                if prop_diff.get(self.NETCONF_PARAMETERS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_CONTROL_PLANE_HEALTH) is not None:
                    obj_2.set_control_plane_health(prop_diff.get(self.NETCONF_PARAMETERS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_CONTROL_PLANE_HEALTH))
                if prop_diff.get(self.NETCONF_PARAMETERS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_SERVICE_LAYER_HEALTH) is not None:
                    obj_2.set_service_layer_health(prop_diff.get(self.NETCONF_PARAMETERS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS, {}).get(self.NETCONF_PARAMETERS_ENABLED_SENSOR_PARAMS_SERVICE_LAYER_HEALTH))
                obj_1.set_enabled_sensor_params(obj_2)
            obj_0.set_netconf_parameters(obj_1)
        if prop_diff.get(self.ID_PERMS) is not None:
            ...
            obj_0.set_id_perms(obj_1)
        if prop_diff.get(self.NETCONF_PROFILE_IS_DEFAULT) is not None:
            obj_0.set_netconf_profile_is_default(prop_diff.get(self.NETCONF_PROFILE_IS_DEFAULT))
        ...
        try:
            self.vnc_lib().netconf_profile_update(obj_0)
        except Exception as e:
            raise Exception(_('%s') % str(e))
    ...
    def handle_delete(self):
        ...
        try:
            self.vnc_lib().netconf_profile_delete(id=self.resource_id)
        except Exception as ex:
            self._ignore_not_found(ex)
            LOG.warn(_('netconf_profile %s already deleted.') % self.name)

    @contrail.set_auth_token
    def _show_resource(self):
        obj = self.vnc_lib().netconf_profile_read(id=self.resource_id)
...
def resource_mapping():
    return {
        'OS::ContrailV2::NetconfProfile': ContrailNetconfProfile,
    }
