                        ...
                        schema={
                            ...
                            NETWORK_POLICY_ENTRIES_POLICY_RULE_ACTION_LIST: properties.Schema(
                                ...
                                schema={
                                    ...
                                    NETWORK_POLICY_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES: properties.Schema(
                                        properties.Schema.MAP,
                                        _('NETWORK_POLICY_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES.'),
                                        update_allowed=True,
                                        required=False,
                                        schema={
                                            NETWORK_POLICY_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES_RETAIN_AS_PATH: properties.Schema(
                                                properties.Schema.BOOLEAN,
                                                _('NETWORK_POLICY_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES_RETAIN_AS_PATH.'),
                                                update_allowed=True,
                                                required=False,
                                            ),
                                        }
                            ...
                            NETWORK_POLICY_ENTRIES_POLICY_RULE_DESCRIPTION: properties.Schema(
                                properties.Schema.STRING,
                                _('NETWORK_POLICY_ENTRIES_POLICY_RULE_DESCRIPTION.'),
                                update_allowed=True,
                                required=False,
                            ),
                        }
            ...
            if self.properties.get(self.NETWORK_POLICY_ENTRIES, {}).get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE) is not None:
                for index_1 in range(len(self.properties.get(self.NETWORK_POLICY_ENTRIES, {}).get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE))):
                    ...
                    if self.properties.get(self.NETWORK_POLICY_ENTRIES, {}).get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE, {})[index_1].get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE_ACTION_LIST) is not None:
                        ...
                        if self.properties.get(self.NETWORK_POLICY_ENTRIES, {}).get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE, {})[index_1].get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES) is not None:
                            obj_4 = vnc_api.ServicePropertiesType()
                            if self.properties.get(self.NETWORK_POLICY_ENTRIES, {}).get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE, {})[index_1].get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES, {}).get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES_RETAIN_AS_PATH) is not None:
                                obj_4.set_retain_as_path(self.properties.get(self.NETWORK_POLICY_ENTRIES, {}).get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE, {})[index_1].get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES, {}).get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES_RETAIN_AS_PATH))
                    ...
                    if self.properties.get(self.NETWORK_POLICY_ENTRIES, {}).get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE, {})[index_1].get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE_DESCRIPTION) is not None:
                        obj_2.set_description(self.properties.get(self.NETWORK_POLICY_ENTRIES, {}).get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE, {})[index_1].get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE_DESCRIPTION))
            ...
            if prop_diff.get(self.NETWORK_POLICY_ENTRIES, {}).get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE) is not None:
                for index_1 in range(len(prop_diff.get(self.NETWORK_POLICY_ENTRIES, {}).get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE))):
                    ...
                    if prop_diff.get(self.NETWORK_POLICY_ENTRIES, {}).get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE, {})[index_1].get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE_ACTION_LIST) is not None:
                        ...
                        if prop_diff.get(self.NETWORK_POLICY_ENTRIES, {}).get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE, {})[index_1].get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES) is not None:
                            obj_4 = vnc_api.ServicePropertiesType()
                            if prop_diff.get(self.NETWORK_POLICY_ENTRIES, {}).get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE, {})[index_1].get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES, {}).get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES_RETAIN_AS_PATH) is not None:
                                obj_4.set_retain_as_path(prop_diff.get(self.NETWORK_POLICY_ENTRIES, {}).get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE, {})[index_1].get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE_ACTION_LIST, {}).get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES, {}).get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE_ACTION_LIST_SERVICE_PROPERTIES_RETAIN_AS_PATH))
                            obj_3.set_service_properties(obj_4)
                    ...
                    if prop_diff.get(self.NETWORK_POLICY_ENTRIES, {}).get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE, {})[index_1].get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE_DESCRIPTION) is not None:
                        obj_2.set_description(prop_diff.get(self.NETWORK_POLICY_ENTRIES, {}).get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE, {})[index_1].get(self.NETWORK_POLICY_ENTRIES_POLICY_RULE_DESCRIPTION))
                    obj_1.add_policy_rule(obj_2)
            obj_0.set_network_policy_entries(obj_1)
