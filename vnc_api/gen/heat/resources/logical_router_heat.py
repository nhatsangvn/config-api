...
class ContrailLogicalRouter(contrail.ContrailResource):
    PROPERTIES = (
        NAME, FQ_NAME, LOGICAL_ROUTER_DHCP_RELAY_SERVER, LOGICAL_ROUTER_DHCP_RELAY_SERVER_IP_ADDRESS, DISPLAY_NAME, CONFIGURED_ROUTE_TARGET_LIST, CONFIGURED_ROUTE_TARGET_LIST_ROUTE_TARGET, PERMS2, PERMS2_OWNER, PERMS2_OWNER_ACCESS, PERMS2_GLOBAL_ACCESS, PERMS2_SHARE, PERMS2_SHARE_TENANT, PERMS2_SHARE_TENANT_ACCESS, ANNOTATIONS, ANNOTATIONS_KEY_VALUE_PAIR, ANNOTATIONS_KEY_VALUE_PAIR_KEY, ANNOTATIONS_KEY_VALUE_PAIR_VALUE, VXLAN_NETWORK_IDENTIFIER, ID_PERMS, ID_PERMS_PERMISSIONS, ID_PERMS_PERMISSIONS_OWNER, ID_PERMS_PERMISSIONS_OWNER_ACCESS, ID_PERMS_PERMISSIONS_GROUP, ID_PERMS_PERMISSIONS_GROUP_ACCESS, ID_PERMS_PERMISSIONS_OTHER_ACCESS, ID_PERMS_UUID, ID_PERMS_UUID_UUID_MSLONG, ID_PERMS_UUID_UUID_LSLONG, ID_PERMS_ENABLE, ID_PERMS_CREATED, ID_PERMS_LAST_MODIFIED, ID_PERMS_DESCRIPTION, ID_PERMS_USER_VISIBLE, ID_PERMS_CREATOR, LOGICAL_ROUTER_TYPE, LOGICAL_ROUTER_GATEWAY_EXTERNAL, FABRIC_REFS, VIRTUAL_MACHINE_INTERFACE_REFS, VIRTUAL_NETWORK_REFS, VIRTUAL_NETWORK_REFS_DATA, VIRTUAL_NETWORK_REFS_DATA_LOGICAL_ROUTER_VIRTUAL_NETWORK_TYPE, TAG_REFS, ROUTE_TABLE_REFS, ROUTE_TARGET_REFS, BGPVPN_REFS, PHYSICAL_ROUTER_REFS, SERVICE_INSTANCE_REFS, PROJECT
    ) = (
        'name', 'fq_name', 'logical_router_dhcp_relay_server', 'logical_router_dhcp_relay_server_ip_address', 'display_name', 'configured_route_target_list', 'configured_route_target_list_route_target', 'perms2', 'perms2_owner', 'perms2_owner_access', 'perms2_global_access', 'perms2_share', 'perms2_share_tenant', 'perms2_share_tenant_access', 'annotations', 'annotations_key_value_pair', 'annotations_key_value_pair_key', 'annotations_key_value_pair_value', 'vxlan_network_identifier', 'id_perms', 'id_perms_permissions', 'id_perms_permissions_owner', 'id_perms_permissions_owner_access', 'id_perms_permissions_group', 'id_perms_permissions_group_access', 'id_perms_permissions_other_access', 'id_perms_uuid', 'id_perms_uuid_uuid_mslong', 'id_perms_uuid_uuid_lslong', 'id_perms_enable', 'id_perms_created', 'id_perms_last_modified', 'id_perms_description', 'id_perms_user_visible', 'id_perms_creator', 'logical_router_type', 'logical_router_gateway_external', 'fabric_refs', 'virtual_machine_interface_refs', 'virtual_network_refs', 'virtual_network_refs_data', 'virtual_network_refs_data_logical_router_virtual_network_type', 'tag_refs', 'route_table_refs', 'route_target_refs', 'bgpvpn_refs', 'physical_router_refs', 'service_instance_refs', 'project'
    )
            ...
            schema=properties.Schema(
                ...
                schema={
                    VIRTUAL_NETWORK_REFS_DATA_LOGICAL_ROUTER_VIRTUAL_NETWORK_TYPE: properties.Schema(
                        ...
                        required=False,
                        constraints=[
                            constraints.AllowedValues([u'ExternalGateway', u'InternalVirtualNetwork', u'NAPTSourcePool']),
                        ],
                    ),
                }
            )
