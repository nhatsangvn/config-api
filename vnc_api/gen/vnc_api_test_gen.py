...
class VncApiTestGen(testtools.TestCase, fixtures.TestWithFixtures):
    ...
    def test_netconf_profile_crud(self):
        self.useFixture(NetconfProfileTestFixtureGen(self._vnc_lib))
    # end test_netconf_profile_crud
    ...
    def test_structured_syslog_tenant_record_crud(self):
        self.useFixture(StructuredSyslogTenantRecordTestFixtureGen(self._vnc_lib))
    # end test_structured_syslog_tenant_record_crud
    ...
    def test_config_properties_crud(self):
        self.useFixture(ConfigPropertiesTestFixtureGen(self._vnc_lib))
    # end test_config_properties_crud
    ...
    def test_snmp_profile_crud(self):
        self.useFixture(SnmpProfileTestFixtureGen(self._vnc_lib))
    # end test_snmp_profile_crud

    def test_node_crud(self):
        self.useFixture(NodeTestFixtureGen(self._vnc_lib))
    # end test_node_crud

    def test_grpc_profile_crud(self):
        self.useFixture(GrpcProfileTestFixtureGen(self._vnc_lib))
    # end test_grpc_profile_crud
